...
_08000630:
	...
	bx lr
	.align 2, 0
_080006DC: .4byte 0x08BBB36C
_080006E0: .4byte 0x08BB72E0

	arm_func_start DecodeString
DecodeString: @ 0x080006E4
	push {r4, r5, r6, r7}
	sub r3, r3, r3
	ldr r5, _080006E0 @ =0x08BB72E0
	ldr r7, _080006DC @ =0x08BBB36C
	ldr r7, [r7]
_080006F8:
	mov r4, r7
_080006FC:
...
MapFloodCoreStep: @ 0x08000784
	...
	ldr r7, [r7, r2, lsl #2]
	ldrb r7, [r7, r1]
	ldr r8, _08000770 @ =0x03004310
	ldrb sl, [r8, r7]
	ldr r7, _08000778 @ =0x03004100
	ldr r7, [r7]
	ldr sb, [r7, r6, lsl #2]
	ldrb sb, [sb, r5]
	add sl, sl, sb
...
_08000848:
	...
	bx lr
	.align 2, 0
_08000850: .4byte 0x03004110
_08000854: .4byte 0x030043B0
_08000858:
...
MapFloodCore: @ 0x08000874
	push {r4, r5, r6, lr}
	mov r4, #0
	ldr r5, _08000774 @ =0x030045C0
	eors r4, r4, #1
	beq _0800089C
	ldr r0, _08000850 @ =0x03004110
	str r0, [r5]
	ldr r0, _08000854 @ =0x030043B0
	str r0, [r5, #4]
	b _080008AC
_0800089C:
	ldr r0, _08000854 @ =0x030043B0
