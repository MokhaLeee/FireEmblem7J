...
_08010D6E:
	...
	movs r0, #0
	str r0, [r5, #0x30]
	ldr r0, _08010D84 @ =ProcScr_UnkEvt
	bl Proc_Find
	str r0, [r5, #0x40]
	pop {r4, r5, r6, r7}
	pop {r0}
	bx r0
	.align 2, 0
_08010D84: .4byte ProcScr_UnkEvt
...
sub_8010F74: @ 0x08010F74
	...
	str r0, [r5, #0x44]
	str r4, [r5, #0x30]
	ldr r0, _08011034 @ =ProcScr_UnkEvt
	bl Proc_Find
	str r0, [r5, #0x40]
	pop {r4, r5, r6, r7}
	pop {r0}
...
_08011034: .4byte ProcScr_UnkEvt
...
sub_8011298: @ 0x08011298
	...
	str r0, [r5, #0x44]
	str r4, [r5, #0x30]
	ldr r0, _08011358 @ =ProcScr_UnkEvt
	bl Proc_Find
	str r0, [r5, #0x40]
	pop {r4, r5, r6, r7}
	pop {r0}
...
_08011358: .4byte ProcScr_UnkEvt
