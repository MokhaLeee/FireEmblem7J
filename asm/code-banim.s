...
AnimScrAdvance: @ 0x080546F0
	...
	beq _0805472C
	ldr r1, [r4, #0x20]
	ldr r0, _0805470C @ =gUnk_08C0A5D8
	cmp r1, r0
	beq _0805472C
	movs r2, #0x3f
	b _08054718
	.align 2, 0
_0805470C: .4byte gUnk_08C0A5D8
_08054710:
	cmp r1, #6
	bne _08054718
	adds r0, #0xc
...
NewEkrChienCHR: @ 0x08054734
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, _08054748 @ =gUnk_08C0A610
	movs r1, #3
	bl Proc_Start
	str r4, [r0, #0x5c]
	pop {r4}
...
UpdateBanimFrame: @ 0x0805480C
	...
	push {r5, r6, r7}
	sub sp, #4
	ldr r0, _080549DC @ =gUnk_08E00008
	mov sb, r0
	ldr r1, _080549E0 @ =gUnk_08FD8008
	mov sl, r1
	...
	ldrsh r4, [r0, r2]
	lsls r0, r5, #5
	ldr r1, _080549DC @ =gUnk_08E00008
	adds r6, r0, r1
	ldr r0, [r6, #0x10]
	...
	bl GetBanimPalette
	lsls r0, r0, #5
	ldr r2, _080549DC @ =gUnk_08E00008
	adds r0, r0, r2
	ldr r0, [r0, #0x1c]
...
InitLeftAnim: @ 0x08054B18
	...
	ldrb r1, [r1]
	mov sb, r1
	ldr r0, _08054C24 @ =gUnk_081DE20D
	...
	cmp r5, #0xff
	bne _08054B80
	ldr r0, _08054C48 @ =gUnk_08C0A5D8
_08054B80:
	adds r1, r6, #0
	bl AnimCreate
	adds r2, r0, #0
...
InitRightAnim: @ 0x08054C5C
	...
	adds r1, r1, r2
	ldrb r7, [r1]
	ldr r1, _08054D48 @ =gUnk_081DE212
	...
	cmp r3, #0xff
	bne _08054CAE
	ldr r0, _08054D68 @ =gUnk_08C0A5D8
_08054CAE:
	adds r1, r4, #0
	bl AnimCreate
	adds r2, r0, #0
...
_08054DF0:
	ldr r0, _08054E40 @ =gUnk_08C0A5D8
	str r0, [r4, #0x24]
	str r0, [r4, #0x20]
	movs r0, #0
	strh r0, [r4, #0x10]
...
sub_08055274: @ 0x08055274
	...
	ldrsh r0, [r6, r1]
	lsls r0, r0, #5
	ldr r1, _080552D0 @ =gUnk_08E00008
	adds r0, r0, r1
	ldr r1, [r0, #0xc]
	ldr r2, [r6, #0x14]
	ldr r4, [r6, #0x18]
...
sub_080552D8: @ 0x080552D8
	...
	sub sp, #4
	adds r5, r0, #0
	ldr r0, _08055360 @ =gUnk_08E00008
	mov sb, r0
	...
	ldr r2, [r1, #0xc]
	ldr r3, [r5, #0x28]
	ldr r7, _08055368 @ =gUnk_08C0A5D8
	cmp r4, #0xff
	beq _08055336
	lsls r0, r4, #2
	adds r0, r0, r2
	...
	adds r7, r3, r0
_08055336:
	ldr r0, _08055368 @ =gUnk_08C0A5D8
	mov sl, r0
	cmp r6, #0xff
	beq _08055348
	lsls r0, r6, #2
...
_08055348:
	...
	b _0805537E
	.align 2, 0
_08055360: .4byte gUnk_08E00008
_08055364: .4byte gBanimRoundScripts
_08055368: .4byte gUnk_08C0A5D8
...
_0805537E:
	...
	adds r0, r1, #0
	lsls r0, r0, #4
	ldr r2, _0805546C @ =gUnk_08FD8008
	adds r0, r0, r2
	ldr r0, [r0, #0xc]
	ldr r1, [r5, #0x20]
	bl LZ77UnCompWram
...
sub_08055474: @ 0x08055474
	...
	push {r6, r7}
	adds r6, r0, #0
	ldr r0, _080554E8 @ =gUnk_08E00008
	mov sb, r0
	...
	ldr r2, [r1, #0xc]
	ldr r3, [r6, #0x28]
	ldr r7, _080554F0 @ =gUnk_08C0A5D8
	cmp r4, #0xff
	beq _080554BE
	lsls r0, r4, #2
	adds r0, r0, r2
	...
	adds r7, r3, r0
_080554BE:
	ldr r0, _080554F0 @ =gUnk_08C0A5D8
	mov r8, r0
	cmp r5, #0xff
	beq _080554D0
	lsls r0, r5, #2
...
_080554D0:
	...
	b _08055506
	.align 2, 0
_080554E8: .4byte gUnk_08E00008
_080554EC: .4byte gBanimRoundScripts
_080554F0: .4byte gUnk_08C0A5D8
...
_08055506:
	...
	adds r0, r1, #0
	lsls r0, r0, #4
	ldr r7, _080555E0 @ =gUnk_08FD8008
	adds r0, r0, r7
	ldr r0, [r0, #0xc]
	ldr r1, [r6, #0x20]
	bl LZ77UnCompWram
...
sub_08055718: @ 0x08055718
	...
	adds r0, r0, r1
	lsls r0, r0, #3
	ldr r2, _08055780 @ =gUnk_08FC0008
	adds r0, r0, r2
	mov r8, r0
	movs r0, #6
	ldrsh r1, [r6, r0]
...
sub_08055B08: @ 0x08055B08
	...
	movs r4, #0
	mov sl, r4
	ldr r0, _08055B4C @ =gUnk_08C0A5E8
	movs r2, #0xc
	ldrsh r1, [r7, r2]
	lsls r2, r1, #3
	adds r2, r2, r0
...
StartSpellAnimation: @ 0x08056070
	...
	lsls r0, r0, #1
	adds r0, r0, r4
	ldr r1, _0805609C @ =gUnk_08C1071C
	movs r2, #0
	ldrsh r0, [r0, r2]
	lsls r0, r0, #2
	adds r0, r0, r1
...
sub_080560A4: @ 0x080560A4
	...
	adds r0, #1
	str r0, [r1]
	ldr r0, _080560E4 @ =gUnk_08C10830
	movs r1, #3
	bl Proc_Start
	str r4, [r0, #0x5c]
	movs r1, #0
...
sub_0805618C: @ 0x0805618C
	...
	adds r4, r0, #0
	adds r5, r1, #0
	ldr r0, _080561CC @ =gUnk_08C10850
	movs r1, #3
	bl Proc_Start
	str r4, [r0, #0x5c]
	movs r1, #0
...
sub_080561F8: @ 0x080561F8
	...
	adds r0, #1
	str r0, [r1]
	ldr r0, _08056224 @ =gUnk_08C10868
	movs r1, #3
	bl Proc_Start
	str r4, [r0, #0x5c]
	movs r1, #0
...
sub_08056284: @ 0x08056284
	...
	adds r0, #1
	str r0, [r1]
	ldr r0, _080562D0 @ =gUnk_08C10888
	movs r1, #3
	bl Proc_Start
	adds r7, r0, #0
	mov r0, r8
...
sub_080566F0: @ 0x080566F0
	...
	adds r0, #1
	str r0, [r1]
	ldr r0, _08056734 @ =gUnk_08C108C0
	movs r1, #3
	bl Proc_Start
	str r5, [r0, #0x5c]
	movs r1, #0
...
sub_08064458: @ 0x08064458
	...
	adds r4, r0, #0
	bl SpellFx_ClearBG1Position
	ldr r0, _08064474 @ =gUnk_08C13A4C
	movs r1, #3
	bl Proc_Start
	str r4, [r0, #0x5c]
	movs r1, #0
...
sub_0806452C: @ 0x0806452C
	push {r4, r5, lr}
	adds r4, r0, #0
	ldr r0, _080645A8 @ =gUnk_08C13A64
	movs r1, #3
	bl Proc_Start
	adds r5, r0, #0
	str r4, [r5, #0x5c]
