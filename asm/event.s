...
_0800AD94: .4byte gUnk_08BFFEF8
	...
	thumb_func_start sub_800AD98
sub_800AD98: @ 0x0800AD98
	push {lr}
	adds r1, r0, #0
...
_0800B3FE:
	...
	thumb_func_start sub_800B404
sub_800B404: @ 0x0800B404
	adds r3, r0, #0
	ldr r0, [r3, #0x30]
	ldrh r2, [r0, #2]
	adds r1, r3, #0
...
_0800B430:
	...
	thumb_func_start sub_800B434
sub_800B434: @ 0x0800B434
	adds r3, r0, #0
	ldr r0, [r3, #0x30]
	ldrh r2, [r0, #2]
	adds r1, r3, #0
...
_0800B492:
	...
	thumb_func_start sub_800B494
sub_800B494: @ 0x0800B494
	push {r4, r5, lr}
	adds r2, r0, #0
	ldr r0, [r2, #0x30]
	ldrh r5, [r0, #2]
...
_0800B4EA:
	...
	bx r1
	.align 2, 0
_0800B4F0: .4byte gDispIo

	thumb_func_start sub_800B4F4
sub_800B4F4: @ 0x0800B4F4
	push {r4, r5, lr}
	adds r4, r0, #0
...
_0800B56E:
	...
	bx r1
	.align 2, 0
_0800B574: .4byte gDispIo

	thumb_func_start sub_800B578
sub_800B578: @ 0x0800B578
	push {r4, r5, lr}
	adds r5, r0, #0
	adds r1, r5, #0
	adds r1, #0x5e
...
_0800B5A6:
	...
	thumb_func_start sub_800B5AC
sub_800B5AC: @ 0x0800B5AC
	push {r4, r5, lr}
	adds r2, r0, #0
	ldr r0, [r2, #0x30]
	ldrh r5, [r0, #2]
...
_0800B630:
	...
	bx r1
	.align 2, 0
_0800B638: .4byte gDispIo

	thumb_func_start sub_800B63C
sub_800B63C: @ 0x0800B63C
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, [r4, #0x34]
	cmp r0, #0
...
_0800B670:
	...
	thumb_func_start sub_800B678
sub_800B678: @ 0x0800B678
	push {r4, r5, r6, lr}
	adds r4, r0, #0
	adds r5, r4, #0
	adds r5, #0x4c
...
sub_800B72C: @ 0x0800B72C
	...
	movs r2, #0
	bl SetBgOffset
	ldr r5, _0800B7B0 @ =gUnk_08C00798
	lsls r4, r6, #1
	adds r4, r4, r6
	lsls r4, r4, #2
	adds r0, r4, r5
	...
	bx r0
	.align 2, 0
_0800B7B0: .4byte gUnk_08C00798
_0800B7B4: .4byte gBg3Tm
...
sub_800B7BC: @ 0x0800B7BC
	...
	movs r2, #0
	bl SetBgOffset
	ldr r5, _0800B83C @ =gUnk_08C00798
	lsls r4, r6, #1
	adds r4, r4, r6
	lsls r4, r4, #2
	adds r0, r4, r5
	...
	bx r0
	.align 2, 0
_0800B83C: .4byte gUnk_08C00798
_0800B840: .4byte gBg3Tm
_0800B844: .4byte gPal

	thumb_func_start sub_800B848
sub_800B848: @ 0x0800B848
	push {r4, r5, r6, r7, lr}
	adds r5, r0, #0
	adds r6, r1, #0
	lsls r2, r2, #0x18
...
sub_80101C8: @ 0x080101C8
	...
	sub sp, #8
	adds r5, r0, #0
	ldr r0, _08010220 @ =gUnk_0819381C
	ldr r1, _08010224 @ =0x06014000
	bl Decompress
	ldr r0, _08010228 @ =gUnk_08193CB8
	movs r1, #0xc0
	lsls r1, r1, #2
	movs r2, #0x20
	bl ApplyPaletteExt
	...
	bx r0
	.align 2, 0
_08010220: .4byte gUnk_0819381C
_08010224: .4byte 0x06014000
_08010228: .4byte gUnk_08193CB8
