...
StartEvt_LymstellaThunderAtk: @ 0x08011AFC
	...
	cmp r0, #0
	bne _08011B28
	ldr r0, _08011B24 @ =gUnk_08C013C8
...
_08011B2A:
	...
	thumb_func_start sub_8011B30
sub_8011B30: @ 0x08011B30
	push {lr}
	ldr r0, _08011B40 @ =gUnk_08C013C8
	bl Proc_Find
	cmp r0, #0
	bne _08011B44
	movs r0, #0
...
_080121A0: .4byte gUnk_08C01654
	...
	thumb_func_start sub_80121A4
sub_80121A4: @ 0x080121A4
	push {r4, r5, r6, r7, lr}
	sub sp, #8
	adds r5, r0, #0
	ldr r0, [r5, #0x30]
