...
sub_08010D88: @ 0x08010D88
	...
	ldr r2, _08010E0C @ =gBG2TilemapBuffer
	movs r1, #0x80
	lsls r1, r1, #3
_08010DB6:
	ldrh r5, [r3]
...
_08010E0C: .4byte gBG2TilemapBuffer
...
sub_08010EEC: @ 0x08010EEC
	...
	movs r2, #0
	bl SetBgOffset
	ldr r0, _08010F40 @ =gBG2TilemapBuffer
	movs r1, #0
	bl BG_Fill
	movs r0, #4
	bl EnableBgSync
...
_08010F38:
	...
	bx r0
	.align 2, 0
_08010F40: .4byte gBG2TilemapBuffer
...
sub_08011038: @ 0x08011038
	...
	bl sub_08013688
	ldr r0, _08011098 @ =gBG2TilemapBuffer
	ldr r2, [r5, #0x2c]
	lsls r1, r2, #1
	adds r1, r1, r2
	lsls r1, r1, #2
...
_08011098: .4byte gBG2TilemapBuffer
_0801109C:
	ldr r0, _080110DC @ =gBG2TilemapBuffer
	movs r1, #0x80
	lsls r1, r1, #5
	ldr r3, [r5, #0x44]
	ldr r2, [r5, #0x2c]
...
_080110AE:
	...
	bx r0
	.align 2, 0
_080110DC: .4byte gBG2TilemapBuffer
...
sub_08011130: @ 0x08011130
	...
	lsls r2, r2, #5
	bl CpuFastSet
	ldr r0, _08011198 @ =gPaletteBuffer
	movs r2, #0x80
	lsls r2, r2, #1
	adds r1, r0, r2
	ldr r2, [r4, #0x44]
	...
	lsls r5, r5, #7
	adds r4, r5, #0
	ldr r3, _080111A0 @ =gBG2TilemapBuffer
...
sub_080111A8: @ 0x080111A8
	...
	bx r0
	.align 2, 0
_080111E0: .4byte gBG2TilemapBuffer
...
sub_0801135C: @ 0x0801135C
	...
	ldr r1, _08011404 @ =gBG2TilemapBuffer
	movs r4, #0x80
	lsls r4, r4, #3
_0801138A:
	ldrh r5, [r2]
...
_08011404: .4byte gBG2TilemapBuffer
...
sub_080114A4: @ 0x080114A4
	push {lr}
	ldr r0, _080114E4 @ =gBG2TilemapBuffer
	movs r1, #0
	bl BG_Fill
	movs r0, #4
	bl EnableBgSync
	...
	bx r0
	.align 2, 0
_080114E4: .4byte gBG2TilemapBuffer
...
sub_08011568: @ 0x08011568
	...
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r0, _0801161C @ =gBG2TilemapBuffer
...
_0801161C: .4byte gBG2TilemapBuffer
...
sub_0801176C: @ 0x0801176C
	push {lr}
	ldr r0, _080117A4 @ =gBG2TilemapBuffer
	movs r1, #0
	bl BG_Fill
	movs r0, #4
	bl EnableBgSync
	...
	bx r0
	.align 2, 0
_080117A4: .4byte gBG2TilemapBuffer
...
sub_08011954: @ 0x08011954
	push {lr}
	ldr r0, _080119BC @ =gBG2TilemapBuffer
	movs r1, #0
	bl BG_Fill
	movs r0, #4
	bl EnableBgSync
	...
	bx r0
	.align 2, 0
_080119BC: .4byte gBG2TilemapBuffer
