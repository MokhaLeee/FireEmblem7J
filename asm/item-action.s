...
_0802C864: .4byte 0x0203A508
_0802C868: .4byte 0x0203A46C

	thumb_func_start sub_0802C86C
sub_0802C86C: @ 0x0802C86C
	push {r4, r5, lr}
	adds r5, r0, #0
...
_0802CB10: .4byte gBmMapTerrain
	...
	thumb_func_start sub_0802CB14
sub_0802CB14: @ 0x0802CB14
	push {r4, r5, r6, lr}
	sub sp, #8
	adds r6, r0, #0
...
_0802CB88: .4byte 0x0203A46C

	thumb_func_start sub_0802CB8C
sub_0802CB8C: @ 0x0802CB8C
	push {lr}
	bl sub_08034A50
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	...
	thumb_func_start sub_0802CB9C
sub_0802CB9C: @ 0x0802CB9C
	push {lr}
...
_0802CC84: .4byte 0x0203A3EC
_0802CC88: .4byte 0x0203A508
_0802CC8C:
	adds r0, r4, #0
	adds r0, #0x4a
	ldrh r0, [r0]
...
_0802CCA4:
	cmp r0, #0x52
	bne _0802CCC8
	ldr r0, _0802CCB0 @ =0x0203A46C
	adds r0, #0x6f
	movs r1, #4
	b _0802CCC6
	.align 2, 0
_0802CCB0: .4byte 0x0203A46C
_0802CCB4:
	ldr r0, _0802CCBC @ =0x0203A46C
	adds r0, #0x6f
	movs r1, #3
	b _0802CCC6
	.align 2, 0
_0802CCBC: .4byte 0x0203A46C
_0802CCC0:
	ldr r0, _0802CCD8 @ =0x0203A46C
	adds r0, #0x6f
	movs r1, #2
_0802CCC6:
	strb r1, [r0]
_0802CCC8:
	...
	bx r0
	.align 2, 0
_0802CCD8: .4byte 0x0203A46C

	thumb_func_start sub_0802CCDC
sub_0802CCDC: @ 0x0802CCDC
	push {r4, r5, r6, r7, lr}
	adds r7, r0, #0
...
_0802CD90: .4byte 0x0203A46C

	thumb_func_start sub_0802CD94
sub_0802CD94: @ 0x0802CD94
	push {r4, r5, r6, lr}
	adds r6, r0, #0
...
_0802CDE8: .4byte gActionSt
	...
	thumb_func_start sub_0802CDEC
sub_0802CDEC: @ 0x0802CDEC
	push {r4, r5, r6, r7, lr}
	adds r7, r0, #0
...
_0802CEB0: .4byte 0x0203A508
_0802CEB4: .4byte 0x0203A3EC

	thumb_func_start sub_0802CEB8
sub_0802CEB8: @ 0x0802CEB8
	push {r4, r5, r6, lr}
	adds r6, r0, #0
...
_0802CF1C: .4byte 0x0203A508
_0802CF20: .4byte 0x0203A3EC

	thumb_func_start sub_0802CF24
sub_0802CF24: @ 0x0802CF24
	push {r4, r5, lr}
	adds r5, r0, #0
...
_0802CF5C: .4byte gActionSt
	...
	thumb_func_start sub_0802CF60
sub_0802CF60: @ 0x0802CF60
	push {r4, r5, lr}
	adds r5, r0, #0
...
_0802CFA0: .4byte gActionSt
	...
	thumb_func_start sub_0802CFA4
sub_0802CFA4: @ 0x0802CFA4
	push {r4, r5, lr}
	adds r5, r0, #0
...
_0802CFE0: .4byte 0x0203A3EC

	thumb_func_start sub_0802CFE4
sub_0802CFE4: @ 0x0802CFE4
	push {r4, r5, lr}
...
sub_0802D06C: @ 0x0802D06C
	...
	cmp r7, sb
	beq _0802D09E
	ldr r3, _0802D118 @ =0x0203A3EC
	ldr r1, _0802D11C @ =0x0203A46C
	lsls r2, r7, #1
	adds r0, r6, #0
	adds r0, #0x1e
	adds r0, r0, r2
...
_0802D0F8:
	...
	bx r0
	.align 2, 0
_0802D118: .4byte 0x0203A3EC
_0802D11C: .4byte 0x0203A46C
_0802D120: .4byte 0x0203A4EC
_0802D124: .4byte 0x0203A3D4

	thumb_func_start sub_0802D128
sub_0802D128: @ 0x0802D128
	push {r4, lr}
...
_0802D144: .4byte gActionSt
	...
	thumb_func_start sub_0802D148
sub_0802D148: @ 0x0802D148
	push {r4, r5, r6, lr}
	mov r6, sb
	mov r5, r8
	push {r5, r6}
	adds r6, r0, #0
	ldr r4, _0802D1D4 @ =0x0203A3EC
	ldr r5, _0802D1D8 @ =0x0203A46C
	adds r0, r5, #0
	adds r0, #0x4a
	movs r2, #0
	mov sb, r2
	...
	bx r0
	.align 2, 0
_0802D1D4: .4byte 0x0203A3EC
_0802D1D8: .4byte 0x0203A46C
_0802D1DC: .4byte 0x0000FFFF
_0802D1E0: .4byte 0x0203A4EC
_0802D1E4: .4byte 0x0203A3D4
...
_0802D31C: .4byte 0x000006DD
	...
	thumb_func_start sub_0802D320
sub_0802D320: @ 0x0802D320
	push {r4, r5, r6, r7, lr}
	adds r7, r0, #0
...
_0802D3C8: .4byte 0x0203A46C

	thumb_func_start sub_0802D3CC
sub_0802D3CC: @ 0x0802D3CC
	push {r4, r5, lr}
	adds r5, r0, #0
...
_0802D43C: .4byte gActionSt
	...
	thumb_func_start sub_0802D440
sub_0802D440: @ 0x0802D440
	push {r4, r5, r6, lr}
	adds r6, r0, #0
	movs r5, #0
...
_0802D4C8: .4byte 0x0203A3D4

	thumb_func_start sub_0802D4CC
sub_0802D4CC: @ 0x0802D4CC
	push {r4, r5, lr}
	adds r5, r0, #0
