...
InitTalk: @ 0x08007C88
	...
	bl InitTextFont
	bl sub_8007DF4
	ldr r0, _08007D14 @ =gUnk_08BFFB68
	ldr r0, [r0]
	strb r6, [r0, #0xa]
	cmp r6, #0
	ble _08007CDE
...
InitSpriteTalk: @ 0x08007D28
	...
	strh r0, [r4]
	ldr r0, _08007DD8 @ =gUnk_08BFFB68
	ldr r0, [r0]
	strb r6, [r0, #0xa]
	movs r5, #0
	cmp r5, r6
...
sub_8007E08: @ 0x08007E08
	push {r4, r5, r6, r7, lr}
	adds r7, r3, #0
	ldr r4, _08007E90 @ =gUnk_08BFFB68
	ldr r3, [r4]
	movs r5, #0
	strb r0, [r3, #0xc]
	ldr r0, [r4]
...
sub_8007F08: @ 0x08007F08
	ldr r1, _08007F10 @ =gUnk_08BFFB68
	ldr r1, [r1]
	strb r0, [r1, #0xa]
	bx lr
	.align 2, 0
_08007F10: .4byte gUnk_08BFFB68

	thumb_func_start sub_8007F14
sub_8007F14: @ 0x08007F14
	ldr r0, _08007F20 @ =gUnk_08BFFB68
	ldr r0, [r0]
	adds r0, #0x80
	movs r1, #0
	strh r1, [r0]
...
sub_8007F24: @ 0x08007F24
	...
	bx lr
	.align 2, 0
_08007F34: .4byte gUnk_08BFFB68

	thumb_func_start sub_8007F38
sub_8007F38: @ 0x08007F38
	ldr r1, _08007F40 @ =gUnk_08BFFB68
	ldr r1, [r1]
	str r0, [r1, #0x38]
	bx lr
	.align 2, 0
_08007F40: .4byte gUnk_08BFFB68

	thumb_func_start sub_8007F44
sub_8007F44: @ 0x08007F44
	ldr r1, _08007F54 @ =gUnk_08BFFB68
	ldr r1, [r1]
	adds r1, #0x80
	ldrh r2, [r1]
	bics r2, r0
	...
	bx lr
	.align 2, 0
_08007F54: .4byte gUnk_08BFFB68

	thumb_func_start sub_8007F58
sub_8007F58: @ 0x08007F58
	ldr r1, _08007F64 @ =gUnk_08BFFB68
	ldr r1, [r1]
	adds r1, #0x80
	ldrh r1, [r1]
	ands r0, r1
	bx lr
	.align 2, 0
_08007F64: .4byte gUnk_08BFFB68

	thumb_func_start sub_8007F68
sub_8007F68: @ 0x08007F68
	ldr r2, _08007F80 @ =gUnk_08BFFB68
	ldr r1, [r2]
	strb r0, [r1, #0x13]
	ldr r2, [r2]
	movs r0, #0x13
...
_08007F7C:
	bx lr
	.align 2, 0
_08007F80: .4byte gUnk_08BFFB68

	thumb_func_start sub_8007F84
sub_8007F84: @ 0x08007F84
	push {r4, r5, r6, lr}
	ldr r2, _08007FB8 @ =gUnk_08BFFB68
	ldr r1, [r2]
	strb r0, [r1, #8]
	movs r4, #0
	ldr r0, [r2]
...
sub_8007FC0: @ 0x08007FC0
	...
	beq _08008038
	bl sub_800EF98
	ldr r0, _0800802C @ =gUnk_08BFFB68
	ldr r0, [r0]
	ldrb r0, [r0, #0x11]
	bl sub_8009E24
	adds r0, r4, #0
...
_08008038:
	...
	cmp r0, #0
	beq _08008062
	ldr r0, _08008070 @ =gUnk_08BFFB68
	ldr r1, [r0]
	movs r0, #1
	strb r0, [r1, #0x12]
_08008062:
...
sub_80080A8: @ 0x080080A8
	...
	b _0800820E
_080080BE:
	ldr r2, _08008108 @ =gUnk_08BFFB68
	ldr r1, [r2]
	movs r0, #0x12
	ldrsb r0, [r1, r0]
	cmp r0, #0
...
_080080E2:
	...
	strb r3, [r0, #0x14]
_080080E6:
	ldr r7, _08008108 @ =gUnk_08BFFB68
...
_0800815C:
	...
	cmp r0, #1
	beq _0800820E
	ldr r5, _080081AC @ =gUnk_08BFFB68
	ldr r4, [r5]
	ldrb r1, [r4, #0xb]
	ldrb r2, [r4, #9]
	adds r0, r1, r2
...
sub_800821C: @ 0x0800821C
	...
	cmp r0, #0
	bne _08008288
	ldr r4, _08008284 @ =gUnk_08BFFB68
	ldr r0, [r4]
	ldrb r0, [r0, #0x11]
	cmp r0, #0xff
	beq _08008288
...
_08008248:
	...
	b _080082F8
	.align 2, 0
_08008284: .4byte gUnk_08BFFB68
_08008288:
	ldr r6, _080082A4 @ =gUnk_08BFFB68
	ldr r5, [r6]
	ldrb r0, [r5, #9]
	ldrb r1, [r5, #0xa]
	cmp r0, r1
...
_08008304: .4byte gBg0Tm
	...
	thumb_func_start sub_8008308
sub_8008308: @ 0x08008308
	push {lr}
	adds r1, r0, #0
	ldr r0, _08008328 @ =gUnk_08BFFB68
	ldr r2, [r0]
	ldrb r0, [r2, #9]
	ldrb r3, [r2, #0xa]
	cmp r0, r3
	...
	movs r0, #0
	strb r0, [r2, #0x12]
	ldr r0, _0800832C @ =gUnk_08BFFCFC
	bl Proc_StartBlocking
	movs r0, #1
	b _0800833C
	.align 2, 0
_08008328: .4byte gUnk_08BFFB68
_0800832C: .4byte gUnk_08BFFCFC
_08008330:
	ldrb r0, [r2, #0x15]
	cmp r0, #0
	bne _0800833A
...
_0800833C:
	...
	thumb_func_start sub_8008340
sub_8008340: @ 0x08008340
	push {lr}
	adds r1, r0, #0
	ldr r0, _08008350 @ =gUnk_08BFFBB4
	bl Proc_StartBlocking
	pop {r0}
	bx r0
	.align 2, 0
...
sub_800836C: @ 0x0800836C
	...
	bx r0
	.align 2, 0
_08008378: .4byte gUnk_08BFFBB4

	thumb_func_start sub_800837C
sub_800837C: @ 0x0800837C
	push {r4, r5, lr}
	ldr r0, _080083BC @ =gUnk_08BFFB68
	ldr r2, [r0]
	ldrb r1, [r2, #8]
	cmp r1, #1
	bne _080083C4
...
_080083CE:
	...
	blt _080083CE
_080083F0:
	ldr r0, _08008404 @ =gUnk_08BFFB68
	ldr r1, [r0]
	movs r0, #1
_080083F6:
	strb r0, [r1, #8]
...
sub_8008408: @ 0x08008408
	...
	cmp r0, #0
	beq _0800842C
	ldr r0, _08008424 @ =gUnk_081902C8
	movs r1, #0x60
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r0, _08008428 @ =gUnk_081902A8
	movs r1, #0x40
	movs r2, #0x20
	bl ApplyPaletteExt
	b _08008440
	.align 2, 0
_08008424: .4byte gUnk_081902C8
_08008428: .4byte gUnk_081902A8
_0800842C:
	ldr r0, _08008444 @ =gUnk_08402A4C
	movs r1, #0x60
	movs r2, #0x20
	bl ApplyPaletteExt
...
sub_800844C: @ 0x0800844C
	...
	mov r8, r0
_08008456:
	ldr r7, _0800848C @ =gUnk_08BFFB68
	adds r5, r7, #0
_0800845A:
	ldr r1, [r5]
	ldr r4, [r1]
...
_08008748:
	...
	beq _08008768
	bl sub_8009598
	ldr r0, _08008764 @ =gUnk_08BFFB68
	ldr r1, [r0]
	ldr r0, [r1]
	adds r0, #1
	str r0, [r1]
...
_08008780:
	bl sub_800968C
_08008784:
	ldr r0, _0800878C @ =gUnk_08BFFB68
	ldr r1, [r0]
	b _08008BBC
	.align 2, 0
_0800878C: .4byte gUnk_08BFFB68
_08008790:
	ldr r1, [r7]
	ldrb r2, [r1, #0xb]
	ldrb r3, [r1, #9]
...
_08008800:
	bl sub_80095E4
	ldr r0, _0800880C @ =gUnk_08BFFB68
	ldr r1, [r0]
	b _08008BBC
	.align 2, 0
_0800880C: .4byte gUnk_08BFFB68
_08008810:
	ldr r1, [r7]
	movs r0, #1
	ldrb r2, [r1, #0x16]
...
_0800881C:
	...
	b _08008BBA
_08008828:
	ldr r4, _08008840 @ =gUnk_08BFFB68
_0800882A:
	ldr r2, [r4]
	ldr r1, [r2]
	ldrb r0, [r1]
...
_08008868:
	...
	bl sub_80095E4
_08008876:
	ldr r4, _080088A8 @ =gUnk_08BFFB68
	ldr r0, [r4]
	ldrb r2, [r0, #0x11]
	lsls r1, r2, #2
	adds r0, #0x18
...
_08008AD8:
	bl sub_800837C
	ldr r0, _08008AE8 @ =gUnk_08BFFB68
	ldr r1, [r0]
	ldr r0, [r1]
	adds r0, #1
	str r0, [r1]
	b _08008456
	.align 2, 0
_08008AE8: .4byte gUnk_08BFFB68
_08008AEC:
	ldr r3, _08008B24 @ =gUnk_08BFFB68
	ldr r1, [r3]
	ldr r2, [r1]
	adds r0, r2, #1
	str r0, [r1]
...
_08008B08:
	...
	blt _08008B08
_08008B1E:
	ldr r0, _08008B24 @ =gUnk_08BFFB68
	ldr r1, [r0]
	b _08008BBC
	.align 2, 0
_08008B24: .4byte gUnk_08BFFB68
...
_08008B3E:
	mov r0, r8
	bl sub_8008340
	ldr r0, _08008B4C @ =gUnk_08BFFB68
	ldr r1, [r0]
	b _08008BBC
	.align 2, 0
_08008B4C: .4byte gUnk_08BFFB68
_08008B50:
	ldr r4, _08008B6C @ =gUnk_08BFFB68
	ldr r1, [r4]
	ldr r0, [r1, #0x3c]
	adds r1, #0x40
	bl sub_80149EC
	...
	b _08008456
	.align 2, 0
_08008B6C: .4byte gUnk_08BFFB68
_08008B70:
	ldr r4, _08008B84 @ =gUnk_08BFFB68
	ldr r1, [r4]
	ldr r0, [r1]
	subs r0, #1
	str r0, [r1, #4]
	...
	b _08008456
	.align 2, 0
_08008B84: .4byte gUnk_08BFFB68
_08008B88:
	ldr r0, _08008B9C @ =gUnk_08BFFB68
	ldr r1, [r0]
	ldr r0, [r1]
	subs r0, #1
	str r0, [r1, #4]
...
_08008CAA:
	...
	thumb_func_start sub_8008CB8
sub_8008CB8: @ 0x08008CB8
	ldr r1, _08008CC0 @ =gUnk_08BFFB68
	ldr r1, [r1]
	strb r0, [r1, #0x11]
	bx lr
	.align 2, 0
_08008CC0: .4byte gUnk_08BFFB68
...
sub_8008CC4: @ 0x08008CC4
	...
	adds r7, r0, #0
	movs r6, #0
	ldr r0, _08008CEC @ =gUnk_08BFFB68
	ldr r0, [r0]
	ldrb r0, [r0, #0x11]
	cmp r0, #0xff
	bne _08008CDA
...
_08008CDA:
	...
	b _08008CF2
	.align 2, 0
_08008CEC: .4byte gUnk_08BFFB68
_08008CF0:
	movs r6, #2
_08008CF2:
	ldr r4, _08008D24 @ =gUnk_08BFFB68
	ldr r0, [r4]
	ldrb r0, [r0, #0x11]
	bl sub_8009D94
	cmp r0, #0xe
...
_08008D30:
	...
	adds r4, r4, r2
_08008D34:
	ldr r5, _08008D54 @ =gUnk_08BFFB68
	ldr r0, [r5]
	ldrb r2, [r0, #0x11]
	lsls r1, r2, #2
	adds r0, #0x18
...
sub_8008DA8: @ 0x08008DA8
	...
	bx r1
	.align 2, 0
_08008DC4: .4byte gUnk_08BFFB68

	thumb_func_start sub_8008DC8
sub_8008DC8: @ 0x08008DC8
	push {r4, lr}
	adds r3, r0, #0
	movs r1, #0
...
_08008DF4:
	...
	thumb_func_start sub_8008DFC
sub_8008DFC: @ 0x08008DFC
	push {r4, r5, r6, r7, lr}
	adds r3, r0, #0
	cmp r1, #0
	beq _08008E0A
...
_08008E24:
	...
	cmp r2, r4
	bgt _08008E52
	ldr r7, _08008E44 @ =gUnk_08BFFB68
_08008E2C:
	ldr r0, [r7]
	lsls r1, r2, #2
	adds r0, #0x18
...
sub_8008E58: @ 0x08008E58
	...
	adds r4, r1, #0
	movs r7, #0
	ldr r0, _08008EAC @ =gUnk_08BFFB68
	mov r8, r0
	ldr r0, [r0]
	lsls r6, r4, #2
	adds r0, #0x18
...
_08008E82:
	...
	bx r0
	.align 2, 0
_08008EAC: .4byte gUnk_08BFFB68

	thumb_func_start sub_8008EB0
sub_8008EB0: @ 0x08008EB0
	push {lr}
	ldr r0, _08008EC0 @ =gUnk_08BFFBBC
	bl Proc_Find
	cmp r0, #0
	bne _08008EC4
	movs r0, #0
...
_08008EC6:
	...
	thumb_func_start sub_8008ECC
sub_8008ECC: @ 0x08008ECC
	push {r4, r5, r6, r7, lr}
	adds r6, r1, #0
	lsls r2, r2, #0x18
	lsrs r7, r2, #0x18
...
_08008F78:
	...
	thumb_func_start sub_8008F80
sub_8008F80: @ 0x08008F80
	push {r4, r5, lr}
	sub sp, #4
	adds r4, r0, #0
	ldr r2, [r4, #0x5c]
...
sub_8009080: @ 0x08009080
	...
	bx r0
	.align 2, 0
_08009094: .4byte gUnk_08BFFB6C
_08009098: .4byte gUnk_08BFFC7C
...
sub_80090C0: @ 0x080090C0
	...
	movs r3, #0
	ldrsh r2, [r0, r3]
	ldr r3, _080090FC @ =gUnk_08BFFC3C
	lsls r0, r4, #2
	adds r0, r0, r3
	ldr r3, [r0]
	movs r0, #4
...
_08009100:
	...
	movs r3, #0
	ldrsh r2, [r0, r3]
	ldr r3, _0800913C @ =gUnk_08BFFC3C
	lsls r0, r4, #2
	adds r0, r0, r3
	ldr r3, [r0]
...
nullsub_24: @ 0x08009148
	...
	thumb_func_start sub_800914C
sub_800914C: @ 0x0800914C
	push {r4, r5, lr}
	adds r3, r0, #0
	adds r4, r1, #0
	adds r5, r2, #0
	ldr r0, _08009174 @ =gUnk_08BFFBFC
	adds r1, r3, #0
	bl Proc_StartBlocking
	adds r2, r0, #0
	adds r0, #0x64
	...
	bx r0
	.align 2, 0
_08009174: .4byte gUnk_08BFFBFC

	thumb_func_start sub_8009178
sub_8009178: @ 0x08009178
	push {r4, r5, r6, lr}
	mov r6, r8
	push {r6}
	adds r4, r0, #0
	...
	adds r6, r2, #0
	mov r8, r3
	ldr r0, _080091A8 @ =gUnk_08BFFBFC
	adds r1, r4, #0
	bl Proc_StartBlocking
	adds r1, r0, #0
	adds r0, #0x64
	...
	bx r0
	.align 2, 0
_080091A8: .4byte gUnk_08BFFBFC

	thumb_func_start sub_80091AC
sub_80091AC: @ 0x080091AC
	push {r4, r5, lr}
	adds r5, r0, #0
	ldr r4, _080091F4 @ =gUnk_08BFFB68
	ldr r2, [r4]
	ldrb r0, [r2, #0xd]
	adds r0, #4
	lsls r0, r0, #5
	...
	b _08009212
	.align 2, 0
_080091F4: .4byte gUnk_08BFFB68
_080091F8: .4byte gBg0Tm
_080091FC:
	ldrb r0, [r1, #9]
	adds r0, #1
	ldrb r1, [r1, #0xa]
...
_08009212:
	...
	thumb_func_start sub_8009218
sub_8009218: @ 0x08009218
	push {r4, r5, lr}
	adds r5, r0, #0
	adds r4, r5, #0
	adds r4, #0x64
...
_08009254:
	...
	thumb_func_start sub_800925C
sub_800925C: @ 0x0800925C
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
	...
	movs r0, #1
	bl TalkBgSync
	ldr r0, _08009304 @ =gUnk_08BFFCBC
	ldr r1, [sp, #0x20]
	bl Proc_StartBlocking
	adds r1, r0, #0
	mov r3, sb
	strh r3, [r1, #0x2a]
	ldr r0, _08009308 @ =gBg0Tm
	subs r5, r5, r0
	asrs r5, r5, #1
	movs r0, #0x1f
	ands r0, r5
	lsls r0, r0, #3
	ldr r2, _0800930C @ =gDispIo
	ldrh r3, [r2, #0x1c]
	subs r0, r0, r3
	add r0, r8
	strh r0, [r1, #0x2c]
...
_080092F6:
	...
	bx r0
	.align 2, 0
_08009304: .4byte gUnk_08BFFCBC
_08009308: .4byte gBg0Tm
_0800930C: .4byte gDispIo

	thumb_func_start sub_8009310
sub_8009310: @ 0x08009310
	push {r4, r5, lr}
	adds r4, r0, #0
...
_08009414: .4byte gpKeySt
	...
	thumb_func_start sub_8009418
sub_8009418: @ 0x08009418
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, _08009450 @ =gUnk_08BFFB68
	ldr r2, [r0]
	ldrb r0, [r2, #0xd]
	adds r0, #4
	lsls r0, r0, #5
	...
	bx r0
	.align 2, 0
_08009450: .4byte gUnk_08BFFB68
_08009454: .4byte gBg0Tm

	thumb_func_start sub_8009458
sub_8009458: @ 0x08009458
	push {r4, r5, r6, r7, lr}
	adds r7, r0, #0
	adds r4, r7, #0
	adds r4, #0x64
	...
	cmp r0, #0xf
	ble _08009538
	ldr r4, _08009540 @ =gUnk_08BFFB68
	ldr r1, [r4]
	ldrb r0, [r1, #9]
	subs r0, #1
	strb r0, [r1, #9]
...
_08009538:
	...
	bx r0
	.align 2, 0
_08009540: .4byte gUnk_08BFFB68
_08009544: .4byte 0x030000C8
_08009548: .4byte gBg0Tm

	thumb_func_start sub_800954C
sub_800954C: @ 0x0800954C
	push {lr}
	adds r3, r0, #0
	movs r0, #0x80
	lsls r0, r0, #2
...
_08009560: .4byte 0x44444444
	...
	thumb_func_start sub_8009564
sub_8009564: @ 0x08009564
	push {r4, lr}
	ldr r0, _08009590 @ =gUnk_08BFFB68
	ldr r1, [r0]
	ldrb r0, [r1, #9]
	subs r0, #1
	strb r0, [r1, #9]
	...
	bx r0
	.align 2, 0
_08009590: .4byte gUnk_08BFFB68
_08009594: .4byte 0x030000D0

	thumb_func_start sub_8009598
sub_8009598: @ 0x08009598
	push {r4, r5, lr}
	ldr r0, _080095CC @ =gUnk_08BFFB68
	ldr r1, [r0]
	movs r0, #0
	strb r0, [r1, #9]
	movs r5, #0
...
sub_80095D4: @ 0x080095D4
	...
	bx lr
	.align 2, 0
_080095E0: .4byte gUnk_08BFFD2C

	thumb_func_start sub_80095E4
sub_80095E4: @ 0x080095E4
	push {lr}
	ldr r0, _0800961C @ =gUnk_08BFFB68
	ldr r1, [r0]
	movs r0, #0xff
	strb r0, [r1, #0xf]
	ldr r0, _08009620 @ =gBg1Tm
	movs r1, #0
	bl TmFill
	movs r0, #2
	bl TalkBgSync
	bl sub_8009628
	ldr r2, _08009624 @ =gDispIo
	movs r0, #0x21
	rsbs r0, r0, #0
	ldrb r1, [r2, #1]
	ands r0, r1
	...
	bx r0
	.align 2, 0
_0800961C: .4byte gUnk_08BFFB68
_08009620: .4byte gBg1Tm
_08009624: .4byte gDispIo
...
sub_8009628: @ 0x08009628
	...
	movs r0, #1
	bl TalkBgSync
	ldr r2, _08009684 @ =gUnk_08BFFB68
	ldr r0, [r2]
	movs r1, #0
	strb r1, [r0, #9]
	ldr r0, [r2]
...
_08009684: .4byte gUnk_08BFFB68
_08009688: .4byte 0x030000C8

	thumb_func_start sub_800968C
sub_800968C: @ 0x0800968C
	push {r4, r5, r6, lr}
	ldr r2, _080096D8 @ =gUnk_08BFFB68
	ldr r0, [r2]
	movs r1, #0
	strb r1, [r0, #9]
	ldr r0, [r2]
...
_08009788:
	...
	mov sl, r0
_08009796:
	ldr r5, _08009818 @ =gUnk_08BFFB68
	ldr r1, [r5]
	adds r0, r6, #1
	strb r0, [r1, #0xc]
	ldr r1, [r5]
...
_080097F2:
	...
	bx r0
	.align 2, 0
_08009818: .4byte gUnk_08BFFB68

	thumb_func_start sub_800981C
sub_800981C: @ 0x0800981C
	push {lr}
	ldr r0, _08009830 @ =gUnk_08BFFD3C
	movs r1, #3
	bl Proc_Start
	adds r0, #0x64
	movs r1, #0
...
sub_80098A0: @ 0x080098A0
	push {r4, r5, r6, lr}
	ldr r4, _0800991C @ =gDispIo
	mov ip, r4
	movs r4, #0x20
	mov r5, ip
	ldrb r5, [r5, #1]
	...
	bx r0
	.align 2, 0
_0800991C: .4byte gDispIo

	thumb_func_start sub_8009920
sub_8009920: @ 0x08009920
	push {r4, r5, r6, lr}
	adds r5, r1, #0
	adds r4, r2, #0
	adds r6, r3, #0
...
_08009AA4: .4byte 0x00003818
	...
	thumb_func_start sub_8009AA8
sub_8009AA8: @ 0x08009AA8
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
nullsub_25: @ 0x08009BE4
	...
	thumb_func_start sub_8009BE8
sub_8009BE8: @ 0x08009BE8
	push {r4, lr}
	movs r1, #0
	str r1, [r0, #0x58]
	movs r0, #0x80
...
_08009C54: .4byte 0x0000E0FF
	...
	thumb_func_start sub_8009C58
sub_8009C58: @ 0x08009C58
	push {r4, r5, lr}
	adds r4, r0, #0
	adds r0, #0x64
	movs r1, #0
	...
	thumb_func_start sub_8009C8C
sub_8009C8C: @ 0x08009C8C
	push {r4, r5, r6, lr}
	sub sp, #4
	adds r5, r0, #0
	ldr r3, [r5, #0x58]
...
_08009D00:
	...
	bx r0
	.align 2, 0
_08009D08: .4byte gDispIo

	thumb_func_start sub_8009D0C
sub_8009D0C: @ 0x08009D0C
	push {r4, r5, lr}
	adds r5, r0, #0
	ldr r0, _08009D68 @ =gUnk_08BFFD4C
	bl Proc_StartBlocking
	adds r4, r0, #0
	adds r0, r5, #0
	bl sub_8009D94
	...
	movs r0, #8
	strh r0, [r1]
	ldr r3, _08009D6C @ =gUnk_08BFFB68
	ldr r0, [r3]
	ldrb r1, [r0, #0xe]
	adds r0, r4, #0
	adds r0, #0x68
...
_08009D58:
	...
	bx r0
	.align 2, 0
_08009D68: .4byte gUnk_08BFFD4C
_08009D6C: .4byte gUnk_08BFFB68

	thumb_func_start sub_8009D70
sub_8009D70: @ 0x08009D70
	ldr r0, _08009D8C @ =gUnk_08BFFB68
	ldr r1, [r0]
	movs r0, #0xf
	ldrsb r0, [r1, r0]
	ldrb r2, [r1, #0x11]
	...
	b _08009D92
	.align 2, 0
_08009D8C: .4byte gUnk_08BFFB68
_08009D90:
	movs r0, #0
_08009D92:
	bx lr

	thumb_func_start sub_8009D94
sub_8009D94: @ 0x08009D94
	push {r4, lr}
	adds r4, r0, #0
	bl IsBattleDeamonActive
	lsls r0, r0, #0x18
...
_08009DAA:
	...
	b _08009DB6
_08009DAE:
	ldr r0, _08009DBC @ =gUnk_08BFFD7C
	lsls r1, r4, #2
	adds r1, r1, r0
	ldr r0, [r1]
_08009DB6:
...
sub_8009DC0: @ 0x08009DC0
	...
	cmp r5, #0xff
	beq _08009E06
	ldr r4, _08009E14 @ =gUnk_08BFFB68
	ldr r0, [r4]
	lsls r5, r5, #2
	adds r0, #0x18
	adds r0, r0, r5
...
sub_8009E78: @ 0x08009E78
	ldr r1, _08009E80 @ =gUnk_08BFFB68
	ldr r1, [r1]
	str r0, [r1, #0x3c]
	bx lr
	.align 2, 0
_08009E80: .4byte gUnk_08BFFB68

	thumb_func_start sub_8009E84
sub_8009E84: @ 0x08009E84
	push {lr}
	adds r1, r0, #0
	ldr r0, _08009E98 @ =gUnk_08BFFB68
	ldr r0, [r0]
	adds r0, #0x60
	bl strcpy
	pop {r0}
...
sub_8009F8C: @ 0x08009F8C
	...
	thumb_func_start sub_8009F98
sub_8009F98: @ 0x08009F98
	push {lr}
	ldr r0, _08009FA8 @ =sub_8009F8C
	movs r1, #1
	bl sub_8014FB0
	pop {r0}
	bx r0
	.align 2, 0
_08009FA8: .4byte sub_8009F8C
...
sub_8009FAC: @ 0x08009FAC
	...
	lsrs r1, r1, #0x18
	mov r8, r1
	ldr r0, _08009FE0 @ =gUnk_08BFFB68
	ldr r0, [r0]
	movs r1, #0xf
	ldrsb r1, [r0, r1]
	mov sb, r1
...
_0800A2F0:
	ldr r0, _0800A308 @ =gUnk_08BFFB68
	ldr r0, [r0]
	ldr r0, [r0, #0x3c]
	mov r1, sp
	bl sub_80149EC
	...
	b _0800A322
	.align 2, 0
_0800A308: .4byte gUnk_08BFFB68
_0800A30C:
	bl sub_802EBB0
	bl GetStringTextLen
	b _0800A326
_0800A316:
	ldr r0, _0800A32C @ =gUnk_08BFFB68
	ldr r0, [r0]
	adds r0, #0x60
	mov r2, r8
	lsls r1, r2, #0x18
...
_0800A368:
	...
	thumb_func_start sub_800A378
sub_800A378: @ 0x0800A378
	push {lr}
	ldr r0, _0800A38C @ =gUnk_08BFFE18
	bl Proc_Find
	cmp r0, #0
	beq _0800A386
	movs r0, #1
_0800A386:
	...
	bx r1
	.align 2, 0
_0800A38C: .4byte gUnk_08BFFE18

	thumb_func_start sub_800A390
sub_800A390: @ 0x0800A390
	push {lr}
	ldr r0, _0800A3A0 @ =gUnk_08BFFE18
	movs r1, #3
	bl Proc_Start
	pop {r0}
	bx r0
	.align 2, 0
_0800A3A0: .4byte gUnk_08BFFE18

	thumb_func_start sub_800A3A4
sub_800A3A4: @ 0x0800A3A4
	movs r1, #1
	str r1, [r0, #0x34]
	bx lr
	.align 2, 0
...
StartTalkDebug: @ 0x0800A3AC
	...
	thumb_func_start sub_800A3B8
sub_800A3B8: @ 0x0800A3B8
	push {lr}
	movs r1, #0
	str r1, [r0, #0x2c]
	bl sub_800A3A4
