...
EventThunderfx_Init: @ 0x08011A24
	push {r4, r5, lr}
	sub sp, #0x14
	ldr r5, _08011AB8 @ =gDispIo
	movs r2, #4
	rsbs r2, r2, #0
	adds r1, r2, #0
	ldrb r3, [r5, #0xc]
	...
	strh r1, [r5, #0x3c]
	str r4, [r0, #0x30]
	ldr r5, _08011AC4 @ =gUnk_08C012FC
	ldr r2, [r0, #0x3c]
	adds r2, #0x54
	ldr r3, [r0, #0x40]
	str r4, [sp]
	...
	bx r0
	.align 2, 0
_08011AB8: .4byte gDispIo
_08011ABC: .4byte 0x0000FFE0
_08011AC0: .4byte 0x0000E0FF
_08011AC4: .4byte gUnk_08C012FC

	thumb_func_start EventThunderfx_End
EventThunderfx_End: @ 0x08011AC8
	push {lr}
	ldr r2, _08011AF8 @ =gDispIo
	adds r1, r2, #0
	adds r1, #0x3c
	movs r0, #0x3f
	ldrb r3, [r1]
	...
	bx r0
	.align 2, 0
_08011AF8: .4byte gDispIo

	thumb_func_start EventE2_Thunderfx
EventE2_Thunderfx: @ 0x08011AFC
	push {r4, r5, lr}
	adds r1, r0, #0
	ldr r0, [r1, #0x30]
	ldr r4, [r0, #4]
	...
	cmp r0, #0
	bne _08011B28
	ldr r0, _08011B24 @ =ProcScr_EventThunderfx
	...
	b _08011B2A
	.align 2, 0
_08011B24: .4byte ProcScr_EventThunderfx
_08011B28:
	movs r0, #0
_08011B2A:
	pop {r4, r5}
...
EventThunderfxExists: @ 0x08011B30
	push {lr}
	ldr r0, _08011B40 @ =ProcScr_EventThunderfx
	bl Proc_Find
	cmp r0, #0
	bne _08011B44
	movs r0, #0
	b _08011B46
	.align 2, 0
_08011B40: .4byte ProcScr_EventThunderfx
_08011B44:
	movs r0, #1
_08011B46:
	pop {r1}
...
sub_80125EC: @ 0x080125EC
	...
	movs r1, #0
	bl BmMapFillg
	ldr r0, _0801263C @ =gUnk_08C0169C
	adds r1, r4, #0
	bl Proc_StartBlocking
	adds r2, r0, #0
	ldr r0, [r4, #0x30]
