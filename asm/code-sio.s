...
Tactician_InitScreen: @ 0x0803F788
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
	...
	bl ClearSioBG
	bl InitSioBG
	ldr r0, _0803F804 @ =Img_TacticianSelObj
	ldr r1, _0803F808 @ =0x06014800
	bl Decompress
	ldr r0, _0803F80C @ =Pal_TacticianSelObj
	movs r1, #0x98
	lsls r1, r1, #2
	movs r2, #0x20
	bl ApplyPaletteExt
...
_0803F804: .4byte Img_TacticianSelObj
_0803F808: .4byte 0x06014800
_0803F80C: .4byte Pal_TacticianSelObj
...
sub_803FA38: @ 0x0803FA38
	...
	ldrsh r0, [r2, r1]
	lsls r0, r0, #6
	ldr r6, _0803FA8C @ =gTacticianTextConf
	adds r2, r0, r6
	adds r1, r7, #0
	adds r1, #0x30
	ldrb r3, [r1]
...
_0803FA82:
	...
	bx r0
	.align 2, 0
_0803FA8C: .4byte gTacticianTextConf

	thumb_func_start TacticianTryAppendChar
TacticianTryAppendChar: @ 0x0803FA90
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	adds r5, r0, #0
...
TacticianTryDeleteChar: @ 0x0803FB28
	push {r4, r5, lr}
	adds r5, r0, #0
	adds r4, r5, #0
	adds r4, #0x38
...
sub_804068C: @ 0x0804068C
	...
	bl ClearSioBG
	bl InitSioBG
	ldr r0, _080407F0 @ =Img_TacticianSelObj
	...
	bl Decompress
	ldr r0, _08040808 @ =Pal_TacticianSelObj
	movs r1, #0x98
	lsls r1, r1, #2
	movs r2, #0x80
	bl ApplyPaletteExt
...
_0804072C:
	...
	bx r0
	.align 2, 0
_080407F0: .4byte Img_TacticianSelObj
...
_08040808: .4byte Pal_TacticianSelObj
...
_08040838: .4byte gSioTexts1
_0804083C: .4byte gSioSt
...
_08040DD4:
	...
	bl sub_8015324
	lsls r0, r6, #5
	ldr r1, _08040E18 @ =Pal_TacticianSelObj
	adds r0, r0, r1
	mov r1, r8
	movs r2, #0x20
	bl ApplyPaletteExt
...
_08040DF8:
	...
	bx r0
	.align 2, 0
_08040E18: .4byte Pal_TacticianSelObj
...
sub_8040E1C: @ 0x08040E1C
	...
	bl ClearSioBG
	bl InitSioBG
	ldr r0, _08040F38 @ =Img_TacticianSelObj
...
_08040E9A:
	...
	bx r0
	.align 2, 0
_08040F38: .4byte Img_TacticianSelObj
...
sub_8041864: @ 0x08041864
	...
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r0, _0804198C @ =Img_TacticianSelObj
	ldr r1, _08041990 @ =0x06014800
	bl Decompress
	ldr r0, _08041994 @ =Pal_TacticianSelObj
	movs r1, #0x98
	lsls r1, r1, #2
	movs r2, #0x80
	bl ApplyPaletteExt
...
_0804198C: .4byte Img_TacticianSelObj
_08041990: .4byte 0x06014800
_08041994: .4byte Pal_TacticianSelObj
...
sub_80419D4: @ 0x080419D4
	...
	bl ClearSioBG
	bl InitSioBG
	ldr r0, _08041AB4 @ =Img_TacticianSelObj
...
_08041AB4: .4byte Img_TacticianSelObj
_08041AB8: .4byte 0x06014800
_08041ABC: .4byte 0x0203DA48
_08041AC0: .4byte gSioTexts2
...
sub_8042010: @ 0x08042010
	...
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r0, _080421E0 @ =Img_TacticianSelObj
	ldr r1, _080421E4 @ =0x06014800
	bl Decompress
	ldr r0, _080421E8 @ =Pal_TacticianSelObj
	movs r1, #0x98
	lsls r1, r1, #2
	movs r2, #0x80
	bl ApplyPaletteExt
...
_080421E0: .4byte Img_TacticianSelObj
_080421E4: .4byte 0x06014800
_080421E8: .4byte Pal_TacticianSelObj
_080421EC: .4byte gBg2Tm + 0x102
_080421F0: .4byte gUnk_081CE034
_080421F4: .4byte 0x0203DA48
_080421F8: .4byte gSioTexts1
_080421FC: .4byte gSioTexts2
...
sub_8042338: @ 0x08042338
	...
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r0, _08042554 @ =Img_TacticianSelObj
...
_08042554: .4byte Img_TacticianSelObj
...
_08042574: .4byte gSioTexts1
_08042578: .4byte gSioTexts2
...
sub_80427A4: @ 0x080427A4
	...
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r0, _08042924 @ =Img_TacticianSelObj
	ldr r1, _08042928 @ =0x06014800
	bl Decompress
	ldr r0, _0804292C @ =Pal_TacticianSelObj
	movs r1, #0x98
	lsls r1, r1, #2
	movs r2, #0x80
	bl ApplyPaletteExt
...
_08042924: .4byte Img_TacticianSelObj
_08042928: .4byte 0x06014800
_0804292C: .4byte Pal_TacticianSelObj
...
StartNameSelect: @ 0x08043310
	push {lr}
	adds r1, r0, #0
	ldr r0, _0804332C @ =ProcScr_TacticianNameSelection
	bl Proc_StartBlocking
	adds r3, r0, #0
	adds r3, #0x33
	movs r2, #0
	...
	bx r0
	.align 2, 0
_0804332C: .4byte ProcScr_TacticianNameSelection

	thumb_func_start StartTacticianNameSelect
StartTacticianNameSelect: @ 0x08043330
	push {r4, lr}
	adds r4, r0, #0
	bl UnpackUiWindowFrameGraphics
	bl UnsetBmStLinkArenaFlag
	...
	ands r0, r2
	strb r0, [r1]
	ldr r0, _0804338C @ =ProcScr_TacticianNameSelection
	adds r1, r4, #0
	bl Proc_StartBlocking
	adds r2, r0, #0
	adds r2, #0x33
...
_0804338C: .4byte ProcScr_TacticianNameSelection
...
sub_80449EC: @ 0x080449EC
	...
	bl Decompress
	ldr r0, _08044AB4 @ =Pal_TacticianSelObj
	movs r1, #0x40
	movs r2, #0x80
	bl ApplyPaletteExt
	movs r0, #0
...
InitSioBG: @ 0x08048320
	push {r4, lr}
	sub sp, #0x18
	ldr r1, _080483A4 @ =SioDefaultBgConfig
	mov r0, sp
	movs r2, #0x18
	bl memcpy
	mov r0, sp
	...
	bx r0
	.align 2, 0
_080483A4: .4byte SioDefaultBgConfig
