...
_0801C67C:
	...
	b _0801C8C8
_0801C696:
	ldr r4, _0801C6F8 @ =0x0202BBB4
	movs r1, #0x16
	ldrsh r0, [r4, r1]
	ldr r5, _0801C6FC @ =0x0202E3D8
	ldr r1, [r5]
	lsls r0, r0, #2
	adds r0, r0, r1
	movs r2, #0x14
...
_0801C700:
	...
	cmp r0, #0
	beq _0801C7D0
	ldr r5, _0801C744 @ =0x0202BBB4
	movs r3, #0x16
	ldrsh r0, [r5, r3]
	ldr r1, _0801C748 @ =0x0202E3D8
	ldr r1, [r1]
	lsls r0, r0, #2
	adds r0, r0, r1
	movs r2, #0x14
...
_0801C7D0:
	...
	cmp r0, #0
	bne _0801C840
	ldr r2, _0801C838 @ =0x0202BBB4
	movs r1, #0x16
	ldrsh r0, [r2, r1]
	ldr r1, _0801C83C @ =0x0202E3D8
	ldr r1, [r1]
	lsls r0, r0, #2
	adds r0, r0, r1
	movs r3, #0x14
...
_0801C840:
	...
	cmp r0, #0
	bne _0801C89C
	ldr r2, _0801C894 @ =0x0202BBB4
	movs r3, #0x16
	ldrsh r0, [r2, r3]
	ldr r1, _0801C898 @ =0x0202E3D8
	ldr r1, [r1]
	lsls r0, r0, #2
	adds r0, r0, r1
	movs r3, #0x14
...
_0801C88A:
	...
	b _0801C8C8
	.align 2, 0
_0801C894: .4byte 0x0202BBB4
_0801C898: .4byte 0x0202E3D8
_0801C89C:
	bl sub_08026434
	ldr r1, _0801C8D0 @ =0x0202BBB4
	movs r0, #0x20
	ldrsh r4, [r1, r0]
	movs r2, #0x22
	ldrsh r5, [r1, r2]
...
sub_0801C8D4: @ 0x0801C8D4
	...
	adds r6, r0, #0
	movs r4, #1
	ldr r5, _0801C93C @ =0x030045B0
	ldr r0, [r5]
	ldr r1, [r0, #4]
	ldrb r2, [r0, #0x1d]
	ldrb r1, [r1, #0x12]
	adds r1, r2, r1
	ldr r2, _0801C940 @ =0x0203A858
	ldrb r2, [r2, #0x10]
	subs r1, r1, r2
	lsls r1, r1, #0x18
	asrs r1, r1, #0x18
...
_0801C91C:
	...
	b _0801C974
	.align 2, 0
_0801C93C: .4byte 0x030045B0
_0801C940: .4byte 0x0203A858
_0801C944: .4byte 0x0202E3F0
_0801C948: .4byte 0x0202E3E4
_0801C94C:
	cmp r0, #3
	bne _0801C974
	ldr r0, _0801C968 @ =0x0202BBB4
	adds r0, #0x3e
	ldrb r0, [r0]
	ands r4, r0
	cmp r4, #0
...
sub_0801CA28: @ 0x0801CA28
	...
	bl m4aSongNumStart
_0801CA3E:
	ldr r1, _0801CA58 @ =0x0202BBB4
	movs r0, #0xfd
	ldrb r2, [r1, #4]
	ands r0, r2
	strb r0, [r1, #4]
	ldr r0, _0801CA5C @ =0x030045B0
	ldr r0, [r0]
	bl sub_0801C8D4
	pop {r0}
	bx r0
...
_0801CC84:
	...
	adds r0, r0, r1
	ldrb r4, [r0]
	ldr r0, _0801CCF8 @ =0x0202BD48
	ldr r1, [r0]
	ldr r0, [r2, #0x14]
	cmp r1, r0
	bne _0801CCB6
	ldr r0, _0801CCFC @ =0x030045B0
	ldr r0, [r0]
	ldrb r4, [r0, #0xb]
_0801CCB6:
	cmp r4, #0
...
_0801CCF0: .4byte 0x0202BBB4
_0801CCF4: .4byte 0x0202E3D8
_0801CCF8: .4byte 0x0202BD48
_0801CCFC: .4byte 0x030045B0
_0801CD00:
	ldr r0, _0801CD38 @ =0x030045B0
	ldr r0, [r0]
	cmp r0, #0
	beq _0801CD78
	ldr r4, _0801CD3C @ =0x0202BD48
	movs r0, #0
	ldrsh r1, [r4, r0]
	movs r3, #2
	ldrsh r2, [r4, r3]
...
_0801CD48:
	...
	b _0801CD78
	.align 2, 0
_0801CD6C: .4byte 0x0202BBB4
_0801CD70:
	adds r0, r5, #0
	movs r1, #0xb
	bl sub_080045FC
_0801CD78:
	ldr r0, _0801CDA0 @ =0x030045B0
	ldr r0, [r0]
	bl sub_0801D270
	cmp r0, #2
	bne _0801CD88
...
_0801CD98:
	...
	bx r0
	.align 2, 0
_0801CDA0: .4byte 0x030045B0
_0801CDA4: .4byte 0x0202BBB4

	thumb_func_start sub_0801CDA8
sub_0801CDA8: @ 0x0801CDA8
	push {lr}
	ldr r2, _0801CDBC @ =0x0203A858
	movs r1, #0
	strb r1, [r2, #0x11]
	movs r1, #2
	bl sub_080045FC
	...
	bx r0
	.align 2, 0
_0801CDBC: .4byte 0x0203A858

	thumb_func_start sub_0801CDC0
sub_0801CDC0: @ 0x0801CDC0
	push {r4, r5, lr}
	adds r5, r0, #0
	ldr r4, _0801CE08 @ =0x030045B0
	ldr r1, [r4]
	ldr r2, _0801CE0C @ =0x0202BD48
	ldrh r0, [r2]
	strb r0, [r1, #0x10]
	ldr r1, [r4]
	ldrh r0, [r2, #2]
	...
	b _0801CE16
	.align 2, 0
_0801CE08: .4byte 0x030045B0
_0801CE0C: .4byte 0x0202BD48
_0801CE10:
	adds r0, r4, #0
	bl UnitBeginCantoAction
_0801CE16:
	ldr r4, _0801CE38 @ =0x030045B0
	ldr r0, [r4]
	bl sub_08026A00
	bl sub_0806D4A4
	ldr r0, [r4]
	...
	bx r0
	.align 2, 0
_0801CE38: .4byte 0x030045B0

	thumb_func_start sub_0801CE3C
sub_0801CE3C: @ 0x0801CE3C
	push {r4, r5, r6, lr}
	adds r6, r0, #0
	ldr r4, _0801CE7C @ =0x0203A858
	ldrb r0, [r4, #0xc]
	bl GetUnit
	movs r5, #0x10
	ldrsb r5, [r0, r5]
...
_0801CF04:
	ldr r0, _0801CF18 @ =0x0202BBB4
	adds r0, #0x3d
	ldrb r0, [r0]
	cmp r0, #0
	beq _0801CF20
	ldr r1, _0801CF1C @ =0x0203A858
	movs r0, #0x1c
	strb r0, [r1, #0x11]
	b _0801CF6C
	.align 2, 0
_0801CF18: .4byte 0x0202BBB4
_0801CF1C: .4byte 0x0203A858
_0801CF20:
	adds r0, r6, #0
	bl sub_0801CDC0
	movs r0, #1
	b _0801CF8C
_0801CF2A:
	ldr r0, _0801CF34 @ =0x0202BBB4
	adds r0, #0x3d
	movs r1, #2
	b _0801CF56
	.align 2, 0
_0801CF34: .4byte 0x0202BBB4
_0801CF38:
	ldr r0, _0801CF40 @ =0x0202BBB4
	adds r0, #0x3d
	movs r1, #4
	b _0801CF56
	.align 2, 0
_0801CF40: .4byte 0x0202BBB4
_0801CF44:
	ldr r0, _0801CF4C @ =0x0202BBB4
	adds r0, #0x3d
	movs r1, #1
	b _0801CF56
	.align 2, 0
_0801CF4C: .4byte 0x0202BBB4
_0801CF50:
	ldr r0, _0801CF68 @ =0x0202BBB4
	adds r0, #0x3d
	movs r1, #8
_0801CF56:
	ldrb r2, [r0]
...
_0801CF5C:
	...
	b _0801CF8C
	.align 2, 0
_0801CF68: .4byte 0x0202BBB4
_0801CF6C:
	ldr r1, _0801CF94 @ =0x0203A858
	ldrb r0, [r1, #0x11]
	cmp r0, #1
	beq _0801CF88
	ldr r0, _0801CF98 @ =0x0202BBB4
	adds r0, #0x3c
	ldrb r0, [r0]
	cmp r0, #0
	bne _0801CF88
...
_0801CF8C:
	...
	bx r1
	.align 2, 0
_0801CF94: .4byte 0x0203A858
_0801CF98: .4byte 0x0202BBB4

	thumb_func_start sub_0801CF9C
sub_0801CF9C: @ 0x0801CF9C
	push {r4, r5, r6, lr}
	adds r6, r0, #0
	ldr r5, _0801CFEC @ =0x030045B0
	ldr r2, [r5]
	ldr r0, [r2]
	ldr r3, [r2, #4]
	ldr r0, [r0, #0x28]
...
_0801CFE8:
	...
	b _0801D04A
	.align 2, 0
_0801CFEC: .4byte 0x030045B0
_0801CFF0: .4byte 0x00010044
_0801CFF4: .4byte 0x0203A858
_0801CFF8:
...
sub_0801D184: @ 0x0801D184
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, _0801D1B4 @ =0x0203A858
	ldrb r0, [r0, #0x11]
	cmp r0, #0x1b
	beq _0801D1A6
	ldr r0, _0801D1B8 @ =0x08C04D68
	ldr r2, _0801D1BC @ =0x0202BBB4
	movs r3, #0x1c
	ldrsh r1, [r2, r3]
	movs r3, #0xc
	ldrsh r2, [r2, r3]
...
_0801D1A6:
	...
	bx r0
	.align 2, 0
_0801D1B4: .4byte 0x0203A858
_0801D1B8: .4byte 0x08C04D68
_0801D1BC: .4byte 0x0202BBB4

	thumb_func_start sub_0801D1C0
sub_0801D1C0: @ 0x0801D1C0
	push {r4, r5, r6, lr}
	adds r6, r0, #0
	ldr r4, _0801D224 @ =0x030045B0
	ldr r1, [r4]
	ldr r5, _0801D228 @ =0x0203A858
	ldrb r0, [r5, #0xe]
	strb r0, [r1, #0x10]
	ldr r1, [r4]
	ldrb r0, [r5, #0xf]
	...
	cmp r0, #0
	bne _0801D20A
	ldr r0, _0801D22C @ =0x0202BBB4
	adds r0, #0x3d
	ldrb r0, [r0]
	cmp r0, #0
	bne _0801D20A
	ldr r0, _0801D230 @ =0x0202E3E0
	ldr r1, [r0]
	ldrb r2, [r5, #0xf]
	lsls r0, r2, #2
	adds r0, r0, r1
...
_0801D20A:
	...
	b _0801D25C
	.align 2, 0
_0801D224: .4byte 0x030045B0
_0801D228: .4byte 0x0203A858
_0801D22C: .4byte 0x0202BBB4
_0801D230: .4byte 0x0202E3E0
_0801D234: .4byte sub_0801D184
_0801D238:
	ldr r0, _0801D264 @ =0x0203A858
	ldrb r0, [r0, #0x11]
	cmp r0, #0x1b
	beq _0801D256
	ldr r0, _0801D268 @ =0x08C04D68
	ldr r2, _0801D26C @ =0x0202BBB4
	movs r3, #0x1c
	ldrsh r1, [r2, r3]
	movs r3, #0xc
	ldrsh r2, [r2, r3]
...
_0801D25C:
	...
	bx r0
	.align 2, 0
_0801D264: .4byte 0x0203A858
_0801D268: .4byte 0x08C04D68
_0801D26C: .4byte 0x0202BBB4
...
_0801D356:
	...
	b _0801D36E
	.align 2, 0
_0801D35C: .4byte 0x0202E3D8
_0801D360: .4byte 0x0202E3E0
_0801D364: .4byte 0x030045B0
_0801D368: .4byte 0x0202BD48
_0801D36C:
	movs r0, #1
_0801D36E:
	pop {r4, r5}
...
sub_0801D3B8: @ 0x0801D3B8
	...
	b _0801D444
	.align 2, 0
_0801D3D4: .4byte 0x030045B0
_0801D3D8:
	movs r0, #0x11
	ldrsb r0, [r2, r0]
	ldr r4, _0801D430 @ =0x0202E3D8
	ldr r1, [r4]
	lsls r0, r0, #2
	adds r0, r0, r1
	movs r1, #0x10
...
sub_0801D47C: @ 0x0801D47C
	...
	b _0801D4C0
	.align 2, 0
_0801D4A4: .4byte 0x08404734
_0801D4A8: .4byte 0x06005080
_0801D4AC: .4byte 0x0202BBB4
_0801D4B0:
...
_0801D658:
	...
	bx r0
	.align 2, 0
_0801D660: .4byte 0x084047B4
_0801D664: .4byte 0x08404814
_0801D668: .4byte 0x08404874
...
sub_0801D6D8: @ 0x0801D6D8
	push {lr}
	ldr r0, _0801D6E4 @ =0x08C02870
	bl sub_08004748
	pop {r0}
	bx r0
	.align 2, 0
_0801D6E4: .4byte 0x08C02870
...
_0801D74A:
	...
	bx r1
	.align 2, 0
_0801D750: .4byte 0x08C02630
_0801D754: .4byte 0x08C0571C

	thumb_func_start sub_0801D758
sub_0801D758: @ 0x0801D758
	push {r4, r5, lr}
	ldr r2, _0801D7AC @ =0x0202E3D8
	ldr r2, [r2]
	lsls r1, r1, #2
	adds r1, r1, r2
	ldr r1, [r1]
