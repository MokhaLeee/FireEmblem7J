	...
	thumb_func_start sub_802B064
sub_802B064: @ 0x0802B064
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	sub sp, #8
...
_0802B158: .4byte gBg0Tm
	...
	thumb_func_start sub_802B15C
sub_802B15C: @ 0x0802B15C
	adds r0, #0x41
	movs r1, #0xff
	strb r1, [r0]
	bx lr

	thumb_func_start sub_802B164
sub_802B164: @ 0x0802B164
	push {r4, r5, r6, r7, lr}
	adds r3, r0, #0
	ldr r4, [r3, #0x14]
	ldr r0, [r3, #0x40]
	...
	cmp r0, #0xff
	beq _0802B1A4
	ldr r0, _0802B1DC @ =gUnk_08C03574
	ldrb r2, [r5]
	lsls r1, r2, #2
	adds r1, r1, r2
	ldrb r2, [r7]
...
_0802B1DC: .4byte gUnk_08C03574

	thumb_func_start sub_802B1E0
sub_802B1E0: @ 0x0802B1E0
	push {r4, lr}
	adds r3, r2, #0
	lsls r2, r1, #1
	adds r2, r2, r1
...
_0802B212:
	...
	thumb_func_start sub_802B21C
sub_802B21C: @ 0x0802B21C
	push {r4, r5, r6, r7, lr}
	movs r1, #0
...
_0802B24C: .4byte 0x0200278C
	...
	thumb_func_start sub_802B250
sub_802B250: @ 0x0802B250
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
	...
	sub sp, #0x14
	adds r5, r0, #0
	ldr r1, _0802B31C @ =gUnk_081C94C8
	mov r0, sp
	movs r2, #2
	bl memcpy
	add r4, sp, #4
	ldr r1, _0802B320 @ =gUnk_081C94CA
	adds r0, r4, #0
	movs r2, #2
	bl memcpy
	movs r0, #0
...
_0802B330: .4byte gBg0Tm
	...
	thumb_func_start sub_802B334
sub_802B334: @ 0x0802B334
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	movs r2, #0
...
_0802B4D8: .4byte 0x00000386
	...
	thumb_func_start sub_802B4DC
sub_802B4DC: @ 0x0802B4DC
	push {r4, lr}
	adds r4, r0, #0
	adds r0, #0x41
	ldrb r0, [r0]
...
_0802B540: .4byte gActionSt
	...
	thumb_func_start sub_802B544
sub_802B544: @ 0x0802B544
	push {r4, r5, lr}
	sub sp, #4
	adds r5, r0, #0
	movs r4, #0
	...
	thumb_func_start sub_802B5D0
sub_802B5D0: @ 0x0802B5D0
	push {r4, lr}
	adds r4, r0, #0
	bl sub_802B334
	adds r4, #0x45
	...
	thumb_func_start sub_802B5E4
sub_802B5E4: @ 0x0802B5E4
	push {r4, r5, lr}
	adds r4, r0, #0
	bl sub_802BD6C
	lsls r0, r0, #0x18
	cmp r0, #0
	beq _0802B620
	ldr r2, _0802B61C @ =gUnk_08C03574
	adds r3, r4, #0
	adds r3, #0x42
	adds r0, r4, #0
	adds r0, #0x41
...
_0802B620:
	adds r0, r4, #0
	bl sub_802B390
	ldr r0, _0802B678 @ =gUnk_08C03574
	adds r3, r4, #0
	adds r3, #0x42
	adds r2, r4, #0
	adds r2, #0x41
...
_0802B6B4:
	...
	cmp r0, #0
	beq _0802B6C6
	ldr r0, _0802B6CC @ =gUnk_08C0366C
	adds r1, r4, #0
...
_0802B730:
	...
	thumb_func_start sub_802B738
sub_802B738: @ 0x0802B738
	push {r4, r5, lr}
	adds r5, r0, #0
	bl sub_802BD6C
	lsls r0, r0, #0x18
	cmp r0, #0
	beq _0802B79C
	ldr r4, _0802B798 @ =gUnk_08C03574
	adds r2, r5, #0
	adds r2, #0x42
	adds r0, r5, #0
	adds r0, #0x41
...
_0802B79C:
	adds r0, r5, #0
	bl sub_802B390
	ldr r4, _0802B814 @ =gUnk_08C03574
	adds r2, r5, #0
	adds r2, #0x42
	adds r0, r5, #0
	adds r0, #0x41
...
_0802B850:
	...
	cmp r0, #0
	beq _0802B862
	ldr r0, _0802B868 @ =gUnk_08C0366C
	adds r1, r5, #0
	bl Proc_StartBlocking
_0802B862:
	pop {r4, r5}
	...
	bx r0
	.align 2, 0
_0802B868: .4byte gUnk_08C0366C

	thumb_func_start sub_802B86C
sub_802B86C: @ 0x0802B86C
	push {r4, r5, r6, lr}
	adds r4, r0, #0
	adds r0, #0x43
	ldrb r0, [r0]
...
sub_802B908: @ 0x0802B908
	...
	thumb_func_start sub_802B91C
sub_802B91C: @ 0x0802B91C
	push {r4, r5, r6, r7, lr}
	adds r2, r0, #0
	ldr r3, [r2, #0x14]
	adds r4, r3, #0
...
_0802B97A:
	...
	movs r0, #0
	bl LoadHelpBoxGfx
	ldr r0, _0802B9B8 @ =gUnk_08C03574
	ldrb r2, [r4]
	lsls r1, r2, #2
	adds r1, r1, r2
	ldrb r5, [r5]
...
_0802B9B2:
	...
	bx r0
	.align 2, 0
_0802B9B8: .4byte gUnk_08C03574
_0802B9BC: .4byte gpKeySt
_0802B9C0: .4byte 0x0000FEFD

	thumb_func_start sub_802B9C4
sub_802B9C4: @ 0x0802B9C4
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
	...
	cmp r0, #0
	beq _0802BA16
	ldr r0, _0802BA90 @ =gUnk_08C03574
	adds r1, r5, r7
	adds r1, r1, r3
	lsls r1, r1, #2
	adds r1, r1, r0
...
_0802BA16:
	...
	bl Proc_Break
_0802BA2C:
	ldr r5, _0802BA90 @ =gUnk_08C03574
	ldrb r0, [r6]
	lsls r1, r0, #2
	adds r1, r1, r0
	mov r2, r8
...
_0802BA82:
	...
	bx r0
	.align 2, 0
_0802BA90: .4byte gUnk_08C03574
_0802BA94: .4byte gpKeySt

	thumb_func_start sub_802BA98
sub_802BA98: @ 0x0802BA98
	push {r4, r5, r6, lr}
	ldr r4, [r0, #0x14]
	adds r5, r4, #0
	adds r5, #0x45
...
_0802BAC4:
	bl CloseHelpBox
	ldr r6, _0802BB24 @ =gUnk_08C03574
	adds r2, r4, #0
	adds r2, #0x42
	adds r0, r4, #0
	adds r0, #0x41
...
_0802BB1E:
	...
	bx r0
	.align 2, 0
_0802BB24: .4byte gUnk_08C03574

	thumb_func_start sub_802BB28
sub_802BB28: @ 0x0802BB28
	push {r4, r5, r6, lr}
	adds r6, r0, #0
	adds r4, r1, #0
	ldr r0, _0802BB80 @ =gUnk_08C035B4
	movs r1, #3
	bl Proc_Start
	adds r2, r0, #0
	str r6, [r2, #0x2c]
...
_0802BB7A:
	...
	bx r1
	.align 2, 0
_0802BB80: .4byte gUnk_08C035B4
_0802BB84: .4byte 0x0203A510

	thumb_func_start sub_802BB88
sub_802BB88: @ 0x0802BB88
...
_0802BBA4: .4byte 0x0203A510
	...
	thumb_func_start sub_802BBA8
sub_802BBA8: @ 0x0802BBA8
...
_0802BBB4: .4byte 0x0203A510
	...
	thumb_func_start sub_802BBB8
sub_802BBB8: @ 0x0802BBB8
...
_0802BBC4: .4byte 0x0203A510
	...
	thumb_func_start sub_802BBC8
sub_802BBC8: @ 0x0802BBC8
...
_0802BBD4: .4byte 0x0203A510
	...
	thumb_func_start sub_802BBD8
sub_802BBD8: @ 0x0802BBD8
...
_0802BBE4: .4byte 0x0203A510
	...
	thumb_func_start sub_802BBE8
sub_802BBE8: @ 0x0802BBE8
...
_0802BBF4: .4byte 0x0203A510
	...
	thumb_func_start sub_802BBF8
sub_802BBF8: @ 0x0802BBF8
	push {r4, lr}
	ldr r0, _0802BC2C @ =0x0203A510
	ldr r0, [r0]
	ldr r2, _0802BC30 @ =gUnk_08C03574
	adds r3, r0, #0
	adds r3, #0x42
	adds r0, #0x41
	ldrb r4, [r0]
...
_0802BC30: .4byte gUnk_08C03574

	thumb_func_start sub_802BC34
sub_802BC34: @ 0x0802BC34
	push {r4, r5, lr}
	ldr r0, _0802BC90 @ =0x0203A510
	ldr r5, [r0]
	ldr r4, _0802BC94 @ =gUnk_08C03574
	adds r2, r5, #0
	adds r2, #0x42
	adds r0, r5, #0
	adds r0, #0x41
...
_0802BC94: .4byte gUnk_08C03574

	thumb_func_start sub_802BC98
sub_802BC98: @ 0x0802BC98
	push {lr}
	adds r1, r0, #0
	ldr r0, _0802BCA8 @ =gUnk_08C0368C
	bl Proc_Start
	pop {r0}
	bx r0
	.align 2, 0
_0802BCA8: .4byte gUnk_08C0368C

	thumb_func_start sub_802BCAC
sub_802BCAC: @ 0x0802BCAC
	push {lr}
	adds r1, r0, #0
	ldr r0, _0802BCBC @ =gUnk_08C036A4
	bl Proc_Start
	pop {r0}
	bx r0
	.align 2, 0
_0802BCBC: .4byte gUnk_08C036A4

	thumb_func_start sub_802BCC0
sub_802BCC0: @ 0x0802BCC0
	adds r0, #0x4c
	movs r1, #0x14
	strh r1, [r0]
	bx lr

	thumb_func_start sub_802BCC8
sub_802BCC8: @ 0x0802BCC8
	push {lr}
	adds r2, r0, #0
	adds r1, r2, #0
	adds r1, #0x4c
...
_0802BCE2:
	...
	thumb_func_start sub_802BCE8
sub_802BCE8: @ 0x0802BCE8
	push {lr}
	adds r1, r0, #0
	...
	cmp r0, #8
	beq _0802BD06
	ldr r0, _0802BD10 @ =gUnk_08C036BC
	bl Proc_StartBlocking
_0802BD06:
	pop {r0}
	bx r0
...
_0802BD10: .4byte gUnk_08C036BC

	thumb_func_start sub_802BD14
sub_802BD14: @ 0x0802BD14
	push {lr}
	adds r1, r0, #0
	adds r0, #0x48
	ldrb r0, [r0]
...
_0802BD26:
	...
	bx r0
	.align 2, 0
_0802BD2C: .4byte gUnk_08C036D4

	thumb_func_start sub_802BD30
sub_802BD30: @ 0x0802BD30
	push {lr}
	adds r1, r0, #0
	...
	bx r0
	.align 2, 0
_0802BD40: .4byte gUnk_08C03728

	thumb_func_start sub_802BD44
sub_802BD44: @ 0x0802BD44
	push {lr}
	adds r1, r0, #0
	...
	bx r0
	.align 2, 0
_0802BD54: .4byte gUnk_08C03784

	thumb_func_start sub_802BD58
sub_802BD58: @ 0x0802BD58
	push {lr}
	adds r1, r0, #0
	...
	bx r0
	.align 2, 0
_0802BD68: .4byte gUnk_08C037D8

	thumb_func_start sub_802BD6C
sub_802BD6C: @ 0x0802BD6C
	push {r4, lr}
	adds r4, r0, #0
	adds r0, #0x48
	ldrb r0, [r0]
