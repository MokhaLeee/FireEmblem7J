...
StartBmVSync: @ 0x0802D840
	push {lr}
	ldr r0, _0802D85C @ =gUnk_08C05414
	movs r1, #0
	bl Proc_Start
	bl BmVSync_AnimInit
	bl sub_802E220
...
_0802D92A:
	...
	thumb_func_start sub_802D930
sub_802D930: @ 0x0802D930
	push {lr}
...
_0802D944: .4byte gPlaySt
	...
	thumb_func_start sub_802D948
sub_802D948: @ 0x0802D948
	push {r4, r5, r6, r7, lr}
	sub sp, #0xc
	mov r1, sp
	ldr r0, _0802D9B0 @ =gUnk_081C9808
	ldm r0!, {r2, r3, r4}
	stm r1!, {r2, r3, r4}
...
_0802D962:
	...
	bx r0
	.align 2, 0
_0802D9B0: .4byte gUnk_081C9808
_0802D9B4: .4byte gPlaySt
_0802D9B8: .4byte gUnk_081C97A8
_0802D9BC: .4byte 0x020027DC

	thumb_func_start sub_802D9C0
sub_802D9C0: @ 0x0802D9C0
	push {r4, r5, r6, r7, lr}
	sub sp, #0xc
	bl GetOamSplice
	cmp r0, #0
...
_0802DA7C: .4byte Sprite_8x8
	...
	thumb_func_start sub_802DA80
sub_802DA80: @ 0x0802DA80
	push {r4, r5, r6, r7, lr}
...
_0802DADC: .4byte gUnk_081C97A8
_0802DAE0: .4byte 0x020027DC

	thumb_func_start sub_802DAE4
sub_802DAE4: @ 0x0802DAE4
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	bl GetOamSplice
	...
	movs r6, #0xff
	movs r5, #0x1f
	ldr r0, _0802DB60 @ =gUnk_08C054C4
	mov r8, r0
_0802DB0E:
	ldrh r1, [r4]
	ldrh r2, [r4, #4]
...
_0802DB60: .4byte gUnk_08C054C4

	thumb_func_start sub_802DB64
sub_802DB64: @ 0x0802DB64
	push {r4, r5, r6, lr}
...
sub_802DDB8: @ 0x0802DDB8
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	ldr r5, _0802DDF0 @ =0x02002ADC
	movs r4, #0
	ldr r0, _0802DDF4 @ =sub_802DD64
	mov r8, r0
	movs r7, #0x1f
...
nullsub_9: @ 0x0802DDFC
	...
	thumb_func_start sub_802DE00
sub_802DE00: @ 0x0802DE00
	push {lr}
...
_0802DEC0: .4byte 0x02002ADC
	...
	thumb_func_start sub_802DEC4
sub_802DEC4: @ 0x0802DEC4
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0802DF50: .4byte sub_802DE00

	thumb_func_start sub_802DF54
sub_802DF54: @ 0x0802DF54
	push {r4, r5, r6, lr}
	...
	bl Decompress
	ldr r0, _0802DFAC @ =gUnk_0819510C
	movs r1, #0xd0
	lsls r1, r1, #2
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r5, _0802DFB0 @ =gUnk_081C97A8
...
_0802DFA4: .4byte gUnk_081950CC
_0802DFA8: .4byte 0x06010300
_0802DFAC: .4byte gUnk_0819510C
_0802DFB0: .4byte gUnk_081C97A8
_0802DFB4: .4byte 0x020027DC

	thumb_func_start sub_802DFB8
...
_0802E030: .4byte 0x02002ADC
	...
	thumb_func_start sub_802E034
sub_802E034: @ 0x0802E034
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
sub_802E0CC: @ 0x0802E0CC
	...
	thumb_func_start sub_802E0DC
sub_802E0DC: @ 0x0802E0DC
	push {r4, r5, r6, lr}
	sub sp, #0x20
	adds r5, r0, #0
	movs r0, #0xd0
...
sub_802E144: @ 0x0802E144
	...
	bl Decompress
	ldr r0, _0802E16C @ =gUnk_08195668
	movs r1, #0xd0
	lsls r1, r1, #2
	movs r2, #0x20
	bl ApplyPaletteExt
	...
	bx r0
	.align 2, 0
_0802E164: .4byte gUnk_0819514C
_0802E168: .4byte 0x020027DC
_0802E16C: .4byte gUnk_08195668
...
sub_802E1EC: @ 0x0802E1EC
	...
	adds r2, r0, #0
	rsbs r2, r2, #0
	ldr r3, _0802E218 @ =gUnk_08C054D0
...
_0802E2F4:
	...
	thumb_func_start sub_802E2F8
sub_802E2F8: @ 0x0802E2F8
	push {lr}
