	...
	thumb_func_start sub_8019FC0
sub_8019FC0: @ 0x08019FC0
	push {r4, r5, lr}
	adds r5, r0, #0
	lsls r4, r1, #0x18
	lsrs r4, r4, #0x18
	...
	bl sub_801A0C0
	ldr r0, _08019FF4 @ =gBmMapMovement
	ldr r1, [r0]
	...
	bx r0
	.align 2, 0
_08019FF4: .4byte gBmMapMovement
_08019FF8: .4byte 0x03004100

	thumb_func_start sub_8019FFC
sub_8019FFC: @ 0x08019FFC
	push {r4, lr}
	adds r4, r0, #0
	bl GetUnitMovementCost
	bl sub_801A0C0
	ldr r0, _0801A028 @ =gBmMapMovement
	ldr r1, [r0]
...
GenerateExtendedMovementMap: @ 0x0801A060
	push {r4, r5, lr}
	adds r4, r0, #0
	adds r5, r1, #0
	adds r0, r2, #0
	bl sub_801A0C0
	ldr r0, _0801A088 @ =gBmMapMovement
	ldr r1, [r0]
	...
	bx r0
	.align 2, 0
_0801A088: .4byte gBmMapMovement
...
_0801A160: .4byte 0x03004100
	...
	thumb_func_start sub_801A164
sub_801A164: @ 0x0801A164
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
	...
	ldr r0, _0801A230 @ =gBmMapTerrain
	ldr r0, [r0]
	mov r1, ip
	lsls r7, r1, #2
	adds r0, r7, r0
...
_0801A3EC: .4byte 0x03004100
	...
	thumb_func_start sub_801A3F0
sub_801A3F0: @ 0x0801A3F0
	sub sp, #0x40
	adds r3, r0, #0
	mov r2, sp
	cmp r1, r3
...
_0801A4FA:
	...
	mov r6, sl
_0801A50E:
	ldr r1, _0801A5C4 @ =gBmMapMovement
	ldr r0, [r1]
	adds r0, r5, r0
	ldr r0, [r0]
	adds r1, r0, r3
	...
	strb r2, [r1]
_0801A538:
	ldr r7, _0801A5C4 @ =gBmMapMovement
	ldr r0, [r7]
	adds r0, r5, r0
	ldr r0, [r0]
	adds r1, r3, r0
...
_0801A55A:
	...
	strb r0, [r1]
_0801A576:
	ldr r2, _0801A5C4 @ =gBmMapMovement
	ldr r0, [r2]
	adds r0, r5, r0
	ldr r0, [r0, #4]
	adds r1, r0, r3
...
_0801A5A4:
	...
	bx r0
	.align 2, 0
_0801A5BC: .4byte gBmMapSize
_0801A5C0: .4byte 0x030045C0
_0801A5C4: .4byte gBmMapMovement

	thumb_func_start sub_801A5C8
sub_801A5C8: @ 0x0801A5C8
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
	push {r5, r6, r7}
	ldr r1, _0801A6A8 @ =gBmMapSize
	movs r2, #2
	ldrsh r0, [r1, r2]
	subs r4, r0, #1
...
_0801A690:
	...
	bx r0
	.align 2, 0
_0801A6A8: .4byte gBmMapSize
_0801A6AC: .4byte 0x030045C0
_0801A6B0: .4byte 0x03004100

	thumb_func_start sub_801A6B4
sub_801A6B4: @ 0x0801A6B4
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0801A79E:
	...
	bx r0
	.align 2, 0
_0801A7B0: .4byte gBmMapSize
_0801A7B4: .4byte 0x03004100

	thumb_func_start sub_801A7B8
sub_801A7B8: @ 0x0801A7B8
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0801A89C:
	...
	bx r0
	.align 2, 0
_0801A8AC: .4byte gBmMapSize
_0801A8B0: .4byte 0x03004100

	thumb_func_start sub_801A8B4
sub_801A8B4: @ 0x0801A8B4
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0801A92A:
	...
	asrs r6, r0, #0x10
_0801A944:
	ldr r0, _0801A9AC @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r5, r0
	ldr r0, [r0]
	add r0, r8
...
_0801A9A0:
	...
	b _0801AF52
	.align 2, 0
_0801A9A8: .4byte gBmMapSize
_0801A9AC: .4byte gBmMapMovement
_0801A9B0: .4byte gBmMapUnit
_0801A9B4: .4byte 0x0202E3F0
_0801A9B8:
	ldr r0, _0801AA44 @ =gBmMapSize
	movs r2, #2
	ldrsh r0, [r0, r2]
	subs r6, r0, #1
	cmp r6, #0
...
_0801A9C6:
	...
	asrs r6, r0, #0x10
_0801A9DE:
	ldr r0, _0801AA48 @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r5, r0
	ldr r0, [r0]
	add r0, r8
...
_0801AA3A:
	...
	b _0801AF52
	.align 2, 0
_0801AA44: .4byte gBmMapSize
_0801AA48: .4byte gBmMapMovement
_0801AA4C: .4byte gBmMapUnit
_0801AA50: .4byte 0x0202E3F0
_0801AA54:
	ldr r0, _0801AAE0 @ =gBmMapSize
	movs r1, #2
	ldrsh r0, [r0, r1]
	subs r6, r0, #1
	cmp r6, #0
...
_0801AA62:
	...
	asrs r6, r0, #0x10
_0801AA7C:
	ldr r0, _0801AAE4 @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r5, r0
	ldr r0, [r0]
	add r0, r8
...
_0801AAD8:
	...
	b _0801AF52
	.align 2, 0
_0801AAE0: .4byte gBmMapSize
_0801AAE4: .4byte gBmMapMovement
_0801AAE8: .4byte gBmMapUnit
_0801AAEC: .4byte 0x0202E3F0
_0801AAF0:
	ldr r0, _0801AB7C @ =gBmMapSize
	movs r2, #2
	ldrsh r0, [r0, r2]
	subs r6, r0, #1
	cmp r6, #0
...
_0801AAFE:
	...
	asrs r6, r0, #0x10
_0801AB16:
	ldr r0, _0801AB80 @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r5, r0
	ldr r0, [r0]
	add r0, r8
...
_0801AB72:
	...
	b _0801AF52
	.align 2, 0
_0801AB7C: .4byte gBmMapSize
_0801AB80: .4byte gBmMapMovement
_0801AB84: .4byte gBmMapUnit
_0801AB88: .4byte 0x0202E3F0
_0801AB8C:
	ldr r0, _0801AC18 @ =gBmMapSize
	movs r1, #2
	ldrsh r0, [r0, r1]
	subs r6, r0, #1
	cmp r6, #0
...
_0801AB9A:
	...
	asrs r6, r0, #0x10
_0801ABB4:
	ldr r0, _0801AC1C @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r5, r0
	ldr r0, [r0]
	add r0, r8
...
_0801AC10:
	...
	b _0801AF52
	.align 2, 0
_0801AC18: .4byte gBmMapSize
_0801AC1C: .4byte gBmMapMovement
_0801AC20: .4byte gBmMapUnit
_0801AC24: .4byte 0x0202E3F0
_0801AC28:
	ldr r0, _0801ACB4 @ =gBmMapSize
	movs r2, #2
	ldrsh r0, [r0, r2]
	subs r6, r0, #1
	cmp r6, #0
...
_0801AC36:
	...
	asrs r6, r0, #0x10
_0801AC4E:
	ldr r0, _0801ACB8 @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r5, r0
	ldr r0, [r0]
	add r0, r8
...
_0801ACB8: .4byte gBmMapMovement
_0801ACBC: .4byte gBmMapUnit
_0801ACC0: .4byte 0x0202E3F0
_0801ACC4:
	ldr r0, _0801AD50 @ =gBmMapSize
	movs r1, #2
	ldrsh r0, [r0, r1]
	subs r6, r0, #1
	cmp r6, #0
...
_0801ACD2:
	...
	asrs r6, r0, #0x10
_0801ACEC:
	ldr r0, _0801AD54 @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r5, r0
	ldr r0, [r0]
	add r0, r8
...
_0801AD48:
	...
	b _0801AF52
	.align 2, 0
_0801AD50: .4byte gBmMapSize
_0801AD54: .4byte gBmMapMovement
_0801AD58: .4byte gBmMapUnit
_0801AD5C: .4byte 0x0202E3F0
_0801AD60:
	ldr r0, _0801AE04 @ =gBmMapSize
	movs r2, #2
	ldrsh r0, [r0, r2]
	subs r6, r0, #1
	cmp r6, #0
...
_0801AD6E:
	...
	asrs r5, r0, #0x10
_0801AD86:
	ldr r0, _0801AE08 @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r7, r0
	ldr r0, [r0]
	add r0, r8
...
_0801ADFC:
	...
	b _0801AF52
	.align 2, 0
_0801AE04: .4byte gBmMapSize
_0801AE08: .4byte gBmMapMovement
_0801AE0C: .4byte gBmMapUnit
_0801AE10: .4byte 0x0202E3F0
_0801AE14:
	ldr r0, _0801AEBC @ =gBmMapSize
	movs r1, #2
	ldrsh r0, [r0, r1]
	subs r6, r0, #1
	cmp r6, #0
...
_0801AE22:
	...
	asrs r5, r0, #0x10
_0801AE3C:
	ldr r0, _0801AEC0 @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r7, r0
	ldr r0, [r0]
	add r0, r8
...
_0801AEB2:
	...
	b _0801AF52
	.align 2, 0
_0801AEBC: .4byte gBmMapSize
_0801AEC0: .4byte gBmMapMovement
_0801AEC4: .4byte gBmMapUnit
_0801AEC8: .4byte 0x0202E3F0
_0801AECC:
	ldr r0, _0801B02C @ =gBmMapSize
	movs r2, #2
	ldrsh r0, [r0, r2]
	subs r6, r0, #1
	cmp r6, #0
...
_0801AED8:
	...
	asrs r6, r0, #0x10
_0801AEF0:
	ldr r0, _0801B030 @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r5, r0
	ldr r0, [r0]
	add r0, r8
...
_0801B00E:
	...
	bge _0801AF72
_0801B014:
	ldr r2, _0801B030 @ =gBmMapMovement
	ldr r1, [r2]
	...
	bx r0
	.align 2, 0
_0801B02C: .4byte gBmMapSize
_0801B030: .4byte gBmMapMovement
_0801B034: .4byte gBmMapUnit
_0801B038: .4byte 0x0202E3F0
_0801B03C: .4byte 0x03004100

	thumb_func_start sub_801B040
sub_801B040: @ 0x0801B040
	push {r4, r5, lr}
	adds r2, r0, #0
	movs r4, #0x10
	ldrsb r4, [r2, r4]
...
_0801B1E8:
	...
	thumb_func_start sub_801B1F0
sub_801B1F0: @ 0x0801B1F0
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0801B22E:
	...
	asrs r7, r0, #0x10
_0801B244:
	ldr r0, _0801B2A4 @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r6, r0
	ldr r0, [r0]
	adds r0, r0, r5
...
_0801B298:
	...
	b _0801B3CA
	.align 2, 0
_0801B2A0: .4byte gBmMapSize
_0801B2A4: .4byte gBmMapMovement
_0801B2A8: .4byte gBmMapUnit
_0801B2AC: .4byte 0x0202E3F0
_0801B2B0:
	ldr r0, _0801B330 @ =gBmMapSize
	movs r1, #2
	ldrsh r0, [r0, r1]
	subs r1, r0, #1
	cmp r1, #0
...
_0801B2BE:
	...
	asrs r7, r0, #0x10
_0801B2D4:
	ldr r0, _0801B334 @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r6, r0
	ldr r0, [r0]
	adds r0, r0, r5
...
_0801B328:
	...
	b _0801B3CA
	.align 2, 0
_0801B330: .4byte gBmMapSize
_0801B334: .4byte gBmMapMovement
_0801B338: .4byte gBmMapUnit
_0801B33C: .4byte 0x0202E3F0
_0801B340:
	ldr r0, _0801B3D8 @ =gBmMapSize
	movs r1, #2
	ldrsh r0, [r0, r1]
	subs r1, r0, #1
	cmp r1, #0
...
_0801B352:
	...
	mov sb, r0
_0801B36E:
	ldr r0, _0801B3DC @ =gBmMapMovement
	ldr r0, [r0]
	adds r0, r6, r0
	ldr r0, [r0]
	adds r0, r0, r5
...
_0801B3CA:
	...
	bx r0
	.align 2, 0
_0801B3D8: .4byte gBmMapSize
_0801B3DC: .4byte gBmMapMovement
_0801B3E0: .4byte gBmMapUnit
_0801B3E4: .4byte 0x0202E3F0

	thumb_func_start sub_801B3E8
sub_801B3E8: @ 0x0801B3E8
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0801B514:
	...
	bx r0
	.align 2, 0
_0801B524: .4byte gBmMapUnit

	thumb_func_start sub_801B528
