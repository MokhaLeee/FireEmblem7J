...
_0804A6BC:
	...
	adds r1, r4, r0
	lsls r1, r1, #1
	ldr r4, _0804A73C @ =0x02022C60
	adds r0, r1, r4
	strh r7, [r0]
	ldr r7, _0804A738 @ =0x02023460
	adds r5, r5, r7
	ldrh r0, [r6]
	strh r0, [r5]
	adds r3, r3, r7
...
_0804A738: .4byte 0x02023460
_0804A73C: .4byte 0x02022C60
...
ClearBg0Bg1: @ 0x0804A828
	...
	bx r0
	.align 2, 0
_0804A844: .4byte 0x02022C60
_0804A848: .4byte 0x02023460
