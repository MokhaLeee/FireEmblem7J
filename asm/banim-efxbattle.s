...
sub_0804EEB8: @ 0x0804EEB8
	...
	lsls r0, r0, #1
	adds r4, r4, r0
	ldr r2, _0804EF14 @ =gBG2TilemapBuffer
	movs r0, #0x20
	str r0, [sp]
	movs r0, #0x14
	str r0, [sp, #4]
...
_0804EF14: .4byte gBG2TilemapBuffer
...
sub_0804EF18: @ 0x0804EF18
	...
	adds r4, r0, #0
	adds r5, r1, #0
	ldr r0, _0804EF50 @ =0x08C0A0E0
	movs r1, #3
	bl Proc_Start
	ldr r2, _0804EF54 @ =0x08C0A0F8
	lsls r1, r4, #3
	adds r1, r1, r2
	ldr r1, [r1]
	str r1, [r0, #0x44]
	...
	bx r1
	.align 2, 0
_0804EF50: .4byte 0x08C0A0E0
_0804EF54: .4byte 0x08C0A0F8
...
sub_0804EFC8: @ 0x0804EFC8
	push {lr}
	ldr r0, _0804EFD8 @ =0x08C0A150
	movs r1, #3
	bl Proc_Start
	pop {r1}
	bx r1
	.align 2, 0
_0804EFD8: .4byte 0x08C0A150
...
_0804F04C:
	...
	b _0804F0C6
	.align 2, 0
_0804F058: .4byte 0x081DDB74
_0804F05C:
	ldr r0, _0804F068 @ =0x081DDB96
	str r0, [r2, #0x44]
	adds r1, r2, #0
	adds r1, #0x29
	movs r0, #0
	b _0804F0C6
	.align 2, 0
_0804F068: .4byte 0x081DDB96
_0804F06C:
	ldr r0, _0804F078 @ =0x081DDBE0
	str r0, [r2, #0x44]
	adds r1, r2, #0
	adds r1, #0x29
	movs r0, #0
	b _0804F0C6
	.align 2, 0
_0804F078: .4byte 0x081DDBE0
_0804F07C:
	ldr r0, _0804F088 @ =0x081DDC2A
	str r0, [r2, #0x44]
	adds r1, r2, #0
	adds r1, #0x29
	movs r0, #0
	b _0804F0C6
	.align 2, 0
_0804F088: .4byte 0x081DDC2A
_0804F08C:
	ldr r0, _0804F098 @ =0x081DDC74
	str r0, [r2, #0x44]
	adds r1, r2, #0
	adds r1, #0x29
	movs r0, #0
	b _0804F0C6
	.align 2, 0
_0804F098: .4byte 0x081DDC74
_0804F09C:
	ldr r0, _0804F0A8 @ =0x081DDCBE
	str r0, [r2, #0x44]
	adds r1, r2, #0
	adds r1, #0x29
	movs r0, #1
	b _0804F0C6
	.align 2, 0
_0804F0A8: .4byte 0x081DDCBE
_0804F0AC:
	ldr r0, _0804F0B8 @ =0x081DDD28
	str r0, [r2, #0x44]
	adds r1, r2, #0
	adds r1, #0x29
	movs r0, #1
	b _0804F0C6
	.align 2, 0
_0804F0B8: .4byte 0x081DDD28
_0804F0BC:
	ldr r0, _0804F0D8 @ =0x081DDB74
	str r0, [r2, #0x44]
	adds r1, r2, #0
	adds r1, #0x29
	movs r0, #0
...
_0804F29C:
	...
	cmp r6, #1
	bne _0804F2D4
	ldr r0, _0804F2D0 @ =0x081DDB96
	b _0804F306
	.align 2, 0
_0804F2C8: .4byte 0x02017740
_0804F2CC: .4byte 0x08C0A180
_0804F2D0: .4byte 0x081DDB96
_0804F2D4:
	cmp r6, #2
	bne _0804F2E0
	ldr r0, _0804F2DC @ =0x081DDBE0
	b _0804F306
	.align 2, 0
_0804F2DC: .4byte 0x081DDBE0
_0804F2E0:
	cmp r6, #3
	bne _0804F2EC
	ldr r0, _0804F2E8 @ =0x081DDC2A
	b _0804F306
	.align 2, 0
_0804F2E8: .4byte 0x081DDC2A
_0804F2EC:
	cmp r6, #4
	bne _0804F2F8
	ldr r0, _0804F2F4 @ =0x081DDE44
	b _0804F306
	.align 2, 0
_0804F2F4: .4byte 0x081DDE44
_0804F2F8:
	cmp r6, #5
	bne _0804F304
	ldr r0, _0804F300 @ =0x081DDEDA
	b _0804F306
	.align 2, 0
_0804F300: .4byte 0x081DDEDA
_0804F304:
	ldr r0, _0804F31C @ =0x081DDB74
_0804F306:
	str r0, [r5, #0x44]
	movs r0, #1
	str r0, [r5, #0x48]
...
sub_0804F8D8: @ 0x0804F8D8
	...
	bx r0
	.align 2, 0
_0804F8F8: .4byte 0x08C0A1C0

	thumb_func_start sub_0804F8FC
sub_0804F8FC: @ 0x0804F8FC
	push {r4, r5, r6, lr}
	adds r6, r0, #0
	ldr r0, _0804F94C @ =gPaletteBuffer
...
_0804F946:
	...
	bx r0
	.align 2, 0
_0804F94C: .4byte gPaletteBuffer
...
sub_0804F954: @ 0x0804F954
	...
	bl Interpolate
	adds r6, r0, #0
	ldr r0, _0804F9BC @ =gPaletteBuffer
...
_0804F9B2:
	...
	bx r0
	.align 2, 0
_0804F9BC: .4byte gPaletteBuffer
...
_0804FA5C:
	ldr r0, _0804FA64 @ =0x081DF3A4
	ldr r1, _0804FA68 @ =0x02022BC0
	b _0804FA7A
	.align 2, 0
...
_0804FA6C:
	...
	cmp r0, #0x50
	bgt _0804FA90
	ldr r0, _0804FA88 @ =0x081DF2A4
	ldr r1, _0804FA8C @ =0x02022BE0
_0804FA7A:
	movs r2, #0x10
	bl CpuSet
	b _0804FA9A
...
_0804FA90:
	ldr r0, _0804FABC @ =0x081DF3A4
	ldr r1, _0804FAC0 @ =0x02022BE0
	movs r2, #0x10
	bl CpuSet
_0804FA9A:
	bl EnablePalSync
...
_0804FAB4:
	...
	bx r0
	.align 2, 0
_0804FABC: .4byte 0x081DF3A4
_0804FAC0: .4byte 0x02022BE0
...
_0804FB04:
	...
	ldrsh r0, [r0, r1]
	lsls r0, r0, #5
	ldr r1, _0804FB2C @ =0x081DF224
	adds r0, r0, r1
_0804FB1A:
	ldr r1, _0804FB30 @ =0x02022BE0
_0804FB1C:
	movs r2, #0x10
	bl CpuSet
	b _0804FB3E
...
_0804FB34:
	ldr r0, _0804FB50 @ =0x081DF3A4
	ldr r1, _0804FB54 @ =0x02022BE0
	movs r2, #0x10
	bl CpuSet
_0804FB3E:
	bl EnablePalSync
	...
	bx r0
	.align 2, 0
_0804FB50: .4byte 0x081DF3A4
_0804FB54: .4byte 0x02022BE0
...
sub_0804FB58: @ 0x0804FB58
	...
	strh r2, [r0, #0x2c]
	str r2, [r0, #0x44]
	ldr r1, _0804FC1C @ =0x081DE00C
	str r1, [r0, #0x48]
	str r2, [r0, #0x54]
	strh r2, [r0, #0x2e]
	str r2, [r0, #0x4c]
	ldr r1, _0804FC20 @ =0x081DE036
	str r1, [r0, #0x50]
	str r2, [r0, #0x58]
	adds r0, #0x29
	strb r3, [r0]
...
_0804FC18: .4byte 0x08C0A218
_0804FC1C: .4byte 0x081DE00C
_0804FC20: .4byte 0x081DE036
_0804FC24: .4byte 0x0203DFF8
_0804FC28: .4byte 0x081DF224
_0804FC2C: .4byte 0x0201F93C
_0804FC30: .4byte 0x081DF2E4
...
_0804FCF4: .4byte 0x02022BC0
_0804FCF8:
	ldr r0, [r4, #0x58]
	lsls r0, r0, #5
	ldr r1, _0804FD34 @ =0x081DF3A4
	adds r0, r0, r1
	ldr r1, _0804FD38 @ =0x02022BC0
	movs r2, #8
	bl CpuFastSet
_0804FD08:
...
_0804FD4C: .4byte 0x02022BE0
_0804FD50:
	ldr r0, [r4, #0x58]
	lsls r0, r0, #5
	ldr r1, _0804FD6C @ =0x081DF3A4
	adds r0, r0, r1
	ldr r1, _0804FD70 @ =0x02022BE0
	movs r2, #8
	bl CpuFastSet
_0804FD60:
	bl EnablePalSync
_0804FD64:
	...
	bx r0
	.align 2, 0
_0804FD6C: .4byte 0x081DF3A4
_0804FD70: .4byte 0x02022BE0
...
_0804FE44: .4byte 0x02022B40
_0804FE48:
	ldr r0, _0804FE6C @ =0x02000054
	ldr r0, [r0, #4]
	ldr r1, _0804FE70 @ =0x02022B80
	movs r2, #8
	bl CpuFastSet
	ldr r0, [r4, #0x5c]
	bl sub_080654C8
...
_08050098: .4byte 0x02022B40
_0805009C: .4byte 0xFFFFFD20
_080500A0:
	ldr r0, _080500D0 @ =0x02000054
	ldr r0, [r0, #4]
	ldr r4, _080500D4 @ =0x02022B80
	adds r1, r4, #0
	movs r2, #8
	bl CpuFastSet
...
sub_080501E4: @ 0x080501E4
	...
	ldr r0, [r0]
	ldr r1, _08050204 @ =0x02022B40
	movs r2, #8
	bl CpuFastSet
	b _08050214
	.align 2, 0
_08050200: .4byte 0x02000054
_08050204: .4byte 0x02022B40
_08050208:
	ldr r0, _08050224 @ =0x02000054
	ldr r0, [r0, #4]
	ldr r1, _08050228 @ =0x02022B80
	movs r2, #8
	bl CpuFastSet
_08050214:
	ldr r0, [r4, #0x5c]
...
sub_0805022C: @ 0x0805022C
	...
	lsls r5, r5, #0x10
	lsrs r5, r5, #0x10
	ldr r0, _08050268 @ =0x08C0A288
	movs r1, #3
	bl Proc_Start
	movs r2, #0
	strh r2, [r0, #0x2c]
	str r2, [r0, #0x44]
	ldr r1, _0805026C @ =0x081DE07A
	str r1, [r0, #0x48]
	str r2, [r0, #0x4c]
	str r2, [r0, #0x50]
	lsls r4, r4, #0x10
...
_080502D6:
	...
	movs r1, #0x1d
	bl sub_08004C20
	ldr r0, _08050314 @ =gPaletteBuffer
	ldr r3, [r4, #0x4c]
	movs r1, #0x1d
	movs r2, #1
	bl sub_08067750
...
_0805030E:
	...
	bx r0
	.align 2, 0
_08050314: .4byte gPaletteBuffer
...
sub_08050348: @ 0x08050348
	...
	cmp r0, #0
	bne _0805038C
	ldr r0, _08050384 @ =0x02022920
	ldr r1, _08050388 @ =0x0201C784
	movs r2, #0x50
	bl CpuFastSet
	b _08050390
	.align 2, 0
_0805037C: .4byte 0x08C0A2B0
_08050380: .4byte 0x02017778
_08050384: .4byte 0x02022920
...
_080505AC:
	...
	subs r0, #1
	bl sub_0806B7DC
	ldr r0, _08050600 @ =gPaletteBuffer
	movs r1, #6
	movs r2, #0xa
	adds r3, r4, #0
	bl sub_080676D4
...
_080505F6:
	...
	bx r0
	.align 2, 0
_08050600: .4byte gPaletteBuffer
...
sub_08050604: @ 0x08050604
	...
	strh r0, [r4, #0x2c]
	str r0, [r4, #0x44]
	ldr r0, _0805063C @ =0x081DE0A8
	str r0, [r4, #0x48]
	ldr r0, _08050640 @ =0x08C0A320
	str r0, [r4, #0x4c]
	ldr r0, _08050644 @ =0x082CDB44
	ldr r1, _08050648 @ =0x06008000
	bl LZ77UnCompVram
	ldr r0, _0805064C @ =0x082D3338
	ldr r1, _08050650 @ =0x02022920
	movs r2, #8
	bl CpuFastSet
	adds r0, r4, #0
	bl Proc_Break
_08050636:
	...
	bx r0
	.align 2, 0
_0805063C: .4byte 0x081DE0A8
_08050640: .4byte 0x08C0A320
_08050644: .4byte 0x082CDB44
_08050648: .4byte 0x06008000
_0805064C: .4byte 0x082D3338
_08050650: .4byte 0x02022920
...
_08050698:
	...
	movs r0, #8
	bl EnableBgSync
	ldr r0, _080506DC @ =gPaletteBuffer
	movs r1, #6
	movs r2, #0xa
	movs r3, #0x10
	bl sub_080676D4
...
_080506DC: .4byte gPaletteBuffer
...
_08050708:
	...
	bl sub_0806B800
_08050712:
	ldr r0, _08050738 @ =gPaletteBuffer
	movs r1, #6
	movs r2, #0xa
	movs r3, #0x10
	bl sub_080676D4
	...
	bx r0
	.align 2, 0
_08050738: .4byte gPaletteBuffer
...
_0805076C:
	...
	subs r0, #1
	bl sub_0806B7DC
	ldr r0, _080507C4 @ =gPaletteBuffer
	movs r1, #6
	movs r2, #0xa
	adds r3, r4, #0
	bl sub_080676D4
...
_080507BC:
	...
	bx r0
	.align 2, 0
_080507C4: .4byte gPaletteBuffer
...
sub_08050FFC: @ 0x08050FFC
	...
	movs r1, #0
	strh r1, [r0, #0x2c]
	ldr r1, _0805101C @ =0x081DDB96
	str r1, [r0, #0x44]
	pop {r4}
	pop {r0}
	bx r0
	.align 2, 0
_08051018: .4byte 0x08C0A330
_0805101C: .4byte 0x081DDB96
