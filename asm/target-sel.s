...
sub_08023F68: @ 0x08023F68
	...
	thumb_func_start sub_08023F9C
sub_08023F9C: @ 0x08023F9C
	push {r4, r5, r6, lr}
	mov r6, r8
	push {r6}
	mov r8, r0
...
_080240E0: .4byte 0x02033E3C
	...
	thumb_func_start sub_080240E4
sub_080240E4: @ 0x080240E4
	push {r4, r5, r6, lr}
	mov r6, r8
	push {r6}
	mov r8, r1
...
_08024148: .4byte sub_080240AC

	thumb_func_start sub_0802414C
sub_0802414C: @ 0x0802414C
	push {r4, r5, lr}
	adds r4, r0, #0
...
_08024260: .4byte sub_0802414C

	thumb_func_start sub_08024264
sub_08024264: @ 0x08024264
	push {r4, r5, lr}
	adds r4, r0, #0
...
_08024380: .4byte sub_080242F8

	thumb_func_start sub_08024384
sub_08024384: @ 0x08024384
	push {r4, r5, lr}
	adds r5, r0, #0
...
_080243EC: .4byte 0x02033E3C
	...
	thumb_func_start sub_080243F0
sub_080243F0: @ 0x080243F0
	push {r4, r5, lr}
	movs r4, #0x10
	ldrsb r4, [r0, r4]
	movs r5, #0x11
...
_080244A0: .4byte 0x02033E3C
	...
	thumb_func_start sub_080244A4
sub_080244A4: @ 0x080244A4
	push {r4, r5, lr}
	movs r4, #0x10
	ldrsb r4, [r0, r4]
	movs r5, #0x11
...
_080244D4: .4byte sub_08024424

	thumb_func_start sub_080244D8
sub_080244D8: @ 0x080244D8
	push {r4, lr}
	adds r4, r0, #0
	adds r0, #0x30
	movs r1, #0xf
...
_0802451C: .4byte 0x02033E3C
	...
	thumb_func_start sub_08024520
sub_08024520: @ 0x08024520
	push {r4, r5, lr}
	movs r4, #0x10
	ldrsb r4, [r0, r4]
	movs r5, #0x11
...
_08024550: .4byte sub_080244D8

	thumb_func_start sub_08024554
sub_08024554: @ 0x08024554
	push {r4, r5, r6, r7, lr}
...
_080245FC: .4byte 0x0001002C
	...
	thumb_func_start sub_08024600
sub_08024600: @ 0x08024600
	push {r4, lr}
	adds r4, r0, #0
...
_08024634: .4byte 0x02033E3C
	...
	thumb_func_start sub_08024638
sub_08024638: @ 0x08024638
	push {r4, r5, r6, r7, lr}
	movs r5, #0x10
	ldrsb r5, [r0, r5]
	movs r6, #0x11
...
_080246A0: .4byte sub_08024600

	thumb_func_start sub_080246A4
sub_080246A4: @ 0x080246A4
	push {r4, r5, lr}
	adds r4, r0, #0
	adds r5, r1, #0
...
_0802475C: .4byte sub_080246A4
_08024760:
	ldr r2, _08024770 @ =sub_080246E4
	adds r0, r5, #0
	adds r1, r6, #0
	bl sub_08023F34
_0802476A:
...
_080248BC: .4byte 0x0001002C
	...
	thumb_func_start sub_080248C0
sub_080248C0: @ 0x080248C0
	push {r4, lr}
	adds r4, r0, #0
...
_08024934: .4byte sub_080248C0

	thumb_func_start sub_08024938
sub_08024938: @ 0x08024938
	push {r4, r5, r6, lr}
	adds r5, r0, #0
	movs r0, #0xc0
	ldrb r1, [r5, #0xb]
...
_080249C0: .4byte sub_08024938

	thumb_func_start sub_080249C4
sub_080249C4: @ 0x080249C4
	push {r4, r5, lr}
	adds r5, r0, #0
...
_08024A48: .4byte sub_080249C4

	thumb_func_start sub_08024A4C
sub_08024A4C: @ 0x08024A4C
	push {r4, r5, r6, lr}
	movs r5, #0x10
	ldrsb r5, [r0, r5]
	movs r6, #0x11
...
_08024B18: .4byte sub_08024A98

	thumb_func_start sub_08024B1C
sub_08024B1C: @ 0x08024B1C
	push {r4, lr}
	adds r4, r0, #0
...
_08024B68: .4byte 0x02033E3C
	...
	thumb_func_start sub_08024B6C
sub_08024B6C: @ 0x08024B6C
	push {r4, r5, lr}
	movs r4, #0x10
	ldrsb r4, [r0, r4]
	movs r5, #0x11
...
_08024B9C: .4byte sub_08024B1C

	thumb_func_start sub_08024BA0
sub_08024BA0: @ 0x08024BA0
	push {r4, lr}
	adds r4, r0, #0
...
_08024BD4: .4byte 0x02033E3C
	...
	thumb_func_start sub_08024BD8
sub_08024BD8: @ 0x08024BD8
	push {lr}
...
_08024C48: .4byte 0x02033E3C
	...
	thumb_func_start sub_08024C4C
sub_08024C4C: @ 0x08024C4C
	push {r4, lr}
	adds r4, r0, #0
...
_08024C94: .4byte 0x02033E3C
	...
	thumb_func_start sub_08024C98
sub_08024C98: @ 0x08024C98
	push {r4, lr}
	adds r4, r0, #0
...
_08024CE0: .4byte 0x02033E3C
	...
	thumb_func_start sub_08024CE4
sub_08024CE4: @ 0x08024CE4
	push {lr}
...
_08024D08: .4byte sub_08024C00

	thumb_func_start sub_08024D0C
sub_08024D0C: @ 0x08024D0C
	push {lr}
...
_08024D30: .4byte sub_08024C4C

	thumb_func_start sub_08024D34
sub_08024D34: @ 0x08024D34
	push {lr}
...
_08024D58: .4byte sub_08024C98

	thumb_func_start sub_08024D5C
sub_08024D5C: @ 0x08024D5C
	push {r4, lr}
	adds r4, r0, #0
...
_08024D90: .4byte 0x02033E3C
	...
	thumb_func_start sub_08024D94
sub_08024D94: @ 0x08024D94
	push {r4, r5, lr}
	movs r4, #0x10
	ldrsb r4, [r0, r4]
	movs r5, #0x11
...
_08024DC4: .4byte sub_08024D5C

	thumb_func_start sub_08024DC8
sub_08024DC8: @ 0x08024DC8
	push {r4, r5, lr}
	movs r4, #0x10
	ldrsb r4, [r0, r4]
	movs r5, #0x11
...
_08024DF8: .4byte sub_080246A4

	thumb_func_start sub_08024DFC
sub_08024DFC: @ 0x08024DFC
	push {r4, r5, lr}
	adds r4, r0, #0
...
_08024E4C:
	...
	thumb_func_start sub_08024E54
sub_08024E54: @ 0x08024E54
	push {r4, r5, lr}
	movs r4, #0x10
	ldrsb r4, [r0, r4]
	movs r5, #0x11
...
_08024E84: .4byte sub_08024DFC

	thumb_func_start sub_08024E88
sub_08024E88: @ 0x08024E88
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	mov r8, r0
...
_08024F10: .4byte 0x0001000C
	...
	thumb_func_start sub_08024F14
sub_08024F14: @ 0x08024F14
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	mov r8, r0
...
_08024F60:
	...
	thumb_func_start sub_08024F6C
sub_08024F6C: @ 0x08024F6C
	push {r4, r5, lr}
	adds r4, r0, #0
	adds r5, r1, #0
...
_08025020: .4byte sub_08024F6C

	thumb_func_start sub_08025024
...
_080250AC: .4byte sub_08025024

	thumb_func_start sub_080250B0
sub_080250B0: @ 0x080250B0
	push {lr}
	adds r3, r0, #0
	movs r2, #0xb
	ldrsb r2, [r3, r2]
...
_080250DC:
	...
	thumb_func_start sub_080250E0
sub_080250E0: @ 0x080250E0
	push {r4, r5, lr}
	movs r4, #0x10
	ldrsb r4, [r0, r4]
	movs r5, #0x11
