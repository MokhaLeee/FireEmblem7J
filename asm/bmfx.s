...
sub_0801D958: @ 0x0801D958
	...
	movs r1, #0
	bl sub_0800140C
	ldr r0, _0801D9EC @ =gBG2TilemapBuffer
	movs r1, #0
	bl BG_Fill
	movs r0, #4
	bl EnableBgSync
...
_0801D9EC: .4byte gBG2TilemapBuffer
...
sub_0801F7B0: @ 0x0801F7B0
	...
	push {r7}
	movs r6, #0
	ldr r4, _0801F80C @ =gBG2TilemapBuffer
	adds r0, r4, #0
	movs r1, #0
	bl BG_Fill
...
_0801F7E8:
	...
	bx r0
	.align 2, 0
_0801F80C: .4byte gBG2TilemapBuffer
...
sub_0801F8F0: @ 0x0801F8F0
	...
	str r1, [sp, #0xc]
	movs r2, #0
	ldr r6, _0801F9D4 @ =gBG2TilemapBuffer
_0801F90A:
	movs r5, #0
	adds r0, r2, #0
	adds r0, #0x10
...
_0801F9D4: .4byte gBG2TilemapBuffer
...
sub_0801F9D8: @ 0x0801F9D8
	...
	movs r1, #0
	bl BG_Fill
	ldr r0, _0801FB64 @ =gBG2TilemapBuffer
	movs r1, #0
	bl BG_Fill
	...
	lsls r0, r0, #3
	bl sub_08001818
	ldr r0, _0801FB90 @ =gPaletteBuffer
	strh r5, [r0]
	bl sub_0801F7B0
	bl sub_0801F81C
	movs r0, #0xf
...
_0801FB64: .4byte gBG2TilemapBuffer
...
_0801FB90: .4byte gPaletteBuffer
...
sub_0801FF3C: @ 0x0801FF3C
	...
	movs r1, #0
	bl sub_0800140C
	ldr r0, _0801FFA4 @ =gPaletteBuffer
	strh r4, [r0]
	bl EnablePalSync
	adds r0, r5, #0
	bl Proc_Break
...
_0801FFA4: .4byte gPaletteBuffer
...
sub_0801FFE0: @ 0x0801FFE0
	...
	orrs r0, r2
	strb r0, [r1]
	ldr r0, _080200C0 @ =gBG2TilemapBuffer
	movs r1, #0
	bl BG_Fill
	movs r0, #4
	bl EnableBgSync
...
_080200C0: .4byte gBG2TilemapBuffer
...
sub_08020350: @ 0x08020350
	...
	adds r4, r0, #0
	bl sub_08002094
	ldr r0, _08020378 @ =gPaletteBuffer
	movs r3, #2
	rsbs r3, r3, #0
	movs r1, #0
	movs r2, #6
	...
	bx r0
	.align 2, 0
_08020378: .4byte gPaletteBuffer
...
sub_08020674: @ 0x08020674
	...
	strh r0, [r4, #0x3c]
	bl sub_08002094
	ldr r4, _080207B8 @ =gPaletteBuffer
	adds r0, r4, #0
	movs r1, #0
	movs r2, #1
	movs r3, #1
...
_080207B8: .4byte gPaletteBuffer
...
sub_08020838: @ 0x08020838
	push {r4, r5, lr}
	bl sub_08002094
	ldr r4, _0802086C @ =gPaletteBuffer
	movs r5, #1
	rsbs r5, r5, #0
	adds r0, r4, #0
	movs r1, #0
	...
	bx r0
	.align 2, 0
_0802086C: .4byte gPaletteBuffer
...
sub_0802089C: @ 0x0802089C
	...
	ands r0, r1
	strb r0, [r2, #1]
	ldr r1, _080208DC @ =gPaletteBuffer
	movs r0, #0
	strh r0, [r1]
	bl EnablePalSync
	pop {r0}
...
_080208DC: .4byte gPaletteBuffer
...
_080211EA:
	...
	bge _080211E8
	movs r3, #0
	ldr r0, _0802128C @ =gPaletteBuffer
	adds r4, r0, #0
	adds r4, #0x40
_08021202:
	lsls r0, r3, #1
...
_0802128C: .4byte gPaletteBuffer
