...
sub_80BBF64: @ 0x080BBF64
	...
	movs r0, #0
	bl SetOnHBlankA
	ldr r0, _080BBF9C @ =HBlank_80BBDD0
	bl SetOnHBlankA
	adds r5, #0x4c
	strh r4, [r5]
	pop {r4, r5}
...
_080BBF9C: .4byte HBlank_80BBDD0
...
_080BC182:
	...
	bl sub_80BBDA8
_080BC1A0:
	ldr r2, _080BC1E0 @ =gUnkOpAnim_02007508
...
_080BC1D4: .4byte OpScanlineSt
_080BC1D8: .4byte 0x02007518
_080BC1DC: .4byte 0x0200751C
_080BC1E0: .4byte gUnkOpAnim_02007508
...
sub_80BDEBC: @ 0x080BDEBC
	...
	movs r0, #0
	mov sb, r0
	ldr r1, _080BDF38 @ =gUnkOpAnim_02007508
	mov sl, r1
_080BDED0:
	mov r3, sb
	lsls r5, r3, #2
...
_080BDF2A:
	...
	b _080BDF4E
	.align 2, 0
_080BDF38: .4byte gUnkOpAnim_02007508
_080BDF3C:
